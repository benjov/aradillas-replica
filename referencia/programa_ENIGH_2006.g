...
6.- INPP MATERIALES DE CONSTRUCCION*/
...
fecha_2011=2011.06;
fecha_inicial_2006=2006.08;
fecha_final_2006=2006.11;
P_46_tortillas_2006=zeros(46,1);
P_46_pan_blanco_2006=zeros(46,1);
P_46_pan_dulce_2006=zeros(46,1);
P_46_pollo_entero_2006=zeros(46,1);
P_46_pollo_piezas_2006=zeros(46,1);
P_46_huevo_2006=zeros(46,1);
P_46_bistec_res_2006=zeros(46,1);
P_46_molida_res_2006=zeros(46,1);
P_46_visceras_res_2006=zeros(46,1);
P_46_chorizo_2006=zeros(46,1);
P_46_jamon_2006=zeros(46,1);
P_46_salchichas_2006=zeros(46,1);
P_46_tocino_2006=zeros(46,1);
P_46_leche_pasteurizada_2006=zeros(46,1);
P_46_leche_en_polvo_2006=zeros(46,1);
P_46_leche_maternizada_2006=zeros(46,1);
P_46_leche_condensada_2006=zeros(46,1);
P_46_queso_fresco_2006=zeros(46,1);
P_46_queso_oaxaca_2006=zeros(46,1);
P_46_queso_amarillo_2006=zeros(46,1);
P_46_crema_de_leche_2006=zeros(46,1);
P_46_mantequilla_2006=zeros(46,1);
P_46_manzana_2006=zeros(46,1);
P_46_platanos_2006=zeros(46,1);
P_46_aguacate_2006=zeros(46,1);
P_46_papaya_2006=zeros(46,1);
P_46_naranja_2006=zeros(46,1);
P_46_limon_2006=zeros(46,1);
P_46_melon_2006=zeros(46,1);
P_46_uvas_2006=zeros(46,1);
P_46_pera_2006=zeros(46,1);
P_46_guayaba_2006=zeros(46,1);
P_46_sandia_2006=zeros(46,1);
P_46_pina_2006=zeros(46,1);
P_46_jitomate_2006=zeros(46,1);
P_46_papa_2006=zeros(46,1);
P_46_cebolla_2006=zeros(46,1);
P_46_tomate_verde_2006=zeros(46,1);
P_46_col_2006=zeros(46,1);
P_46_lechuga_2006=zeros(46,1);
P_46_calabacita_2006=zeros(46,1);
P_46_zanahoria_2006=zeros(46,1);
P_46_chile_serrano_2006=zeros(46,1);
P_46_nopales_2006=zeros(46,1);
P_46_chayote_2006=zeros(46,1);
P_46_chile_poblano_2006=zeros(46,1);
P_46_pepino_2006=zeros(46,1);
P_46_ejotes_2006=zeros(46,1);
P_46_chicharo_2006=zeros(46,1);
P_46_frijol_2006=zeros(46,1);
P_46_jugos_nectares_2006=zeros(46,1);
P_46_refrescos_envasados_2006=zeros(46,1);
P_46_agua_embotellada_2006=zeros(46,1);
P_46_antibioticos_2006=zeros(46,1);
P_46_cardiovasculares_2006=zeros(46,1);
P_46_analgesicos_2006=zeros(46,1);
P_46_nutricionales_2006=zeros(46,1);
P_46_gastrointestinales_2006=zeros(46,1);
P_46_antigripales_2006=zeros(46,1);
P_46_medicinas_tos_2006=zeros(46,1);
P_46_medicinas_piel_2006=zeros(46,1);
P_46_autobus_foraneo_2006=zeros(46,1);
P_46_transporte_aereo_2006=zeros(46,1);
P_46_materiales_2006=zeros(46,1);
i=1;
do while i .le 46;
P_46_tortillas_2006[i]=
quantile(precios_46_tortillas[i]*selif(inpc_46_tortilla, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha	.ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_tortilla, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq  fecha_2011)), 0.5);	
	
P_46_pan_blanco_2006[i]=
quantile(precios_46_pan_blanco[i]*selif(inpc_46_pan_blanco, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_pan_blanco, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq  fecha_2011)), 0.5);	
	
P_46_pan_dulce_2006[i]=
quantile(precios_46_pan_dulce[i]*selif(inpc_46_pan_dulce, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_pan_dulce, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq  fecha_2011)), 0.5);	
	
P_46_pollo_entero_2006[i]=
quantile(precios_46_pollo_entero[i]*selif(inpc_46_pollo, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha	.ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_pollo, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha	.eq  fecha_2011)), 0.5);	
	
P_46_pollo_piezas_2006[i]=
quantile(precios_46_pollo_piezas[i]*selif(inpc_46_pollo, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha	.ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_pollo, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha	.eq  fecha_2011)), 0.5);

P_46_huevo_2006[i]=
quantile(precios_46_huevo[i]*selif(inpc_46_huevo, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha	.ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_huevo, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha	.eq  fecha_2011)), 0.5);

P_46_bistec_res_2006[i]=
quantile(precios_46_bistec_res[i]*selif(inpc_46_carne_res, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha	.ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_carne_res, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha	.eq  fecha_2011)), 0.5);

P_46_molida_res_2006[i]=
quantile(precios_46_molida_res[i]*selif(inpc_46_carne_res, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha	.ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_carne_res, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha	.eq  fecha_2011)), 0.5);

P_46_visceras_res_2006[i]=
quantile(precios_46_visceras_res[i]*selif(inpc_46_visceras_res, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_visceras_res, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq  fecha_2011)), 0.5);

P_46_chorizo_2006[i]=
quantile(precios_46_chorizo[i]*selif(inpc_46_chorizo, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_chorizo, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq  fecha_2011)), 0.5);

P_46_jamon_2006[i]=
quantile(precios_46_jamon[i]*selif(inpc_46_jamon, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_jamon, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha	.eq fecha_2011)), 0.5);

P_46_salchichas_2006[i]=
quantile(precios_46_salchichas[i]*selif(inpc_46_salchichas, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_salchichas, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_tocino_2006[i]=
quantile(precios_46_tocino[i]*selif(inpc_46_tocino, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./	selif(inpc_46_tocino, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_leche_pasteurizada_2006[i]=
quantile(precios_46_leche_pasteurizada[i]*selif(inpc_46_leche_pasteurizada, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_leche_pasteurizada, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_leche_en_polvo_2006[i]=
quantile(precios_46_leche_en_polvo[i]*selif(inpc_46_leche_en_polvo, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_leche_en_polvo, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_leche_maternizada_2006[i]=
quantile(precios_46_leche_maternizada[i]*selif(inpc_46_leche_evaporada, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_leche_evaporada, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_leche_condensada_2006[i]=
quantile(precios_46_leche_condensada[i]*selif(inpc_46_leche_evaporada, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_leche_evaporada, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_queso_fresco_2006[i]=
quantile(precios_46_queso_fresco[i]*selif(inpc_46_queso_fresco, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_queso_fresco, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_queso_oaxaca_2006[i]=
quantile(precios_46_queso_oaxaca[i]*selif(inpc_46_queso_oaxaca, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_queso_oaxaca, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_queso_amarillo_2006[i]=
quantile(precios_46_queso_amarillo[i]*selif(inpc_46_queso_amarillo, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_queso_amarillo, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_crema_de_leche_2006[i]=
quantile(precios_46_crema_de_leche[i]*selif(inpc_46_crema_de_leche, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_crema_de_leche, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_mantequilla_2006[i]=
quantile(precios_46_mantequilla[i]*selif(inpc_46_mantequilla, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_mantequilla, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_manzana_2006[i]=
quantile(precios_46_manzana[i]*selif(inpc_46_manzana, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_manzana, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_platanos_2006[i]=
quantile(precios_46_platanos[i]*selif(inpc_46_platano, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_platano, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_aguacate_2006[i]=
quantile(precios_46_aguacate[i]*selif(inpc_46_aguacate, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_aguacate, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_papaya_2006[i]=
quantile(precios_46_papaya[i]*selif(inpc_46_papaya, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_papaya, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_naranja_2006[i]=
quantile(precios_46_naranja[i]*selif(inpc_46_naranja, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_naranja, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_limon_2006[i]=
quantile(precios_46_limon[i]*selif(inpc_46_limon, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha	.ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_limon, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha	.eq fecha_2011)), 0.5);

P_46_melon_2006[i]=
quantile(precios_46_melon[i]*selif(inpc_46_melon, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha	.ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_melon, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha	.eq fecha_2011)), 0.5);

P_46_uvas_2006[i]=
quantile(precios_46_uvas[i]*selif(inpc_46_uva, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_uva, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_pera_2006[i]=
quantile(precios_46_pera[i]*selif(inpc_46_pera, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_pera, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_guayaba_2006[i]=
quantile(precios_46_guayaba[i]*selif(inpc_46_guayaba, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_guayaba, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_sandia_2006[i]=
quantile(precios_46_sandia[i]*selif(inpc_46_sandia, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_sandia, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_pina_2006[i]=
quantile(precios_46_pina[i]*selif(inpc_46_pina, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_pina, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_jitomate_2006[i]=
quantile(precios_46_jitomate[i]*selif(inpc_46_jitomate, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_jitomate, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_papa_2006[i]=
quantile(precios_46_papa[i]*selif(inpc_46_papa, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_papa, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_cebolla_2006[i]=
quantile(precios_46_cebolla[i]*selif(inpc_46_cebolla, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_cebolla, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_tomate_verde_2006[i]=
quantile(precios_46_tomate_verde[i]*selif(inpc_46_tomate_verde, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_tomate_verde, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_col_2006[i]=
quantile(precios_46_col[i]*selif(inpc_46_lechuga_col, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_lechuga_col, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_lechuga_2006[i]=
quantile(precios_46_lechuga[i]*selif(inpc_46_lechuga_col, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_lechuga_col, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_calabacita_2006[i]=
quantile(precios_46_calabacita[i]*selif(inpc_46_calabacita, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_calabacita, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_zanahoria_2006[i]=
quantile(precios_46_zanahoria[i]*selif(inpc_46_zanahoria, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha	.ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_zanahoria, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha	.eq fecha_2011)), 0.5);

P_46_chile_serrano_2006[i]=
quantile(precios_46_chile_serrano[i]*selif(inpc_46_chile_serrano, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha	.ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_chile_serrano, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha	.eq fecha_2011)), 0.5);

P_46_nopales_2006[i]=
quantile(precios_46_nopales[i]*selif(inpc_46_nopales, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_nopales, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_chayote_2006[i]=
quantile(precios_46_chayote[i]*selif(inpc_46_chayote, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_chayote, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_chile_poblano_2006[i]=
quantile(precios_46_chile_poblano[i]*selif(inpc_46_chile_poblano, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha	.ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_chile_poblano, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha	.eq fecha_2011)), 0.5);

P_46_pepino_2006[i]=
quantile(precios_46_pepino[i]*selif(inpc_46_pepino, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_pepino, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_ejotes_2006[i]=
quantile(precios_46_ejotes[i]*selif(inpc_46_ejotes, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_ejotes, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_chicharo_2006[i]=
quantile(precios_46_chicharo[i]*selif(inpc_46_chicharo, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_chicharo, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_frijol_2006[i]=
quantile(precios_46_frijol[i]*selif(inpc_46_frijol, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_frijol, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_jugos_nectares_2006[i]=
quantile(precios_46_jugos_nectares[i]*selif(inpc_46_jugos_nectares, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_jugos_nectares, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_refrescos_envasados_2006[i]=
quantile(precios_46_refrescos_envasados[i]*selif(inpc_46_refrescos, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha	.ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_refrescos, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha	.eq fecha_2011)), 0.5);

P_46_agua_embotellada_2006[i]=
quantile(precios_46_agua_embotellada[i]*selif(inpc_46_agua_embotellada, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_agua_embotellada, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_antibioticos_2006[i]=
quantile(precios_46_antibioticos[i]*selif(inpc_46_antibioticos, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_antibioticos, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_cardiovasculares_2006[i]=
quantile(precios_46_cardiovasculares[i]*selif(inpc_46_cardiovasculares, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_cardiovasculares, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_analgesicos_2006[i]=
quantile(precios_46_analgesicos[i]*selif(inpc_46_analgesicos, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_analgesicos, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_nutricionales_2006[i]=
quantile(precios_46_nutricionales[i]*selif(inpc_46_nutricionales, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha	.ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_nutricionales, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha	.eq fecha_2011)), 0.5);

P_46_gastrointestinales_2006[i]=
quantile(precios_46_gastrointestinales[i]*selif(inpc_46_gastrointestinales, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_gastrointestinales, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_antigripales_2006[i]=
quantile(precios_46_antigripales[i]*selif(inpc_46_antigripales, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_antigripales, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_medicinas_tos_2006[i]=
quantile(precios_46_medicinas_tos[i]*selif(inpc_46_medicina_tos, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_medicina_tos, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_medicinas_piel_2006[i]=
quantile(precios_46_medicinas_piel[i]*selif(inpc_46_medicina_piel, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha	.ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_medicina_piel, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha	.eq fecha_2011)), 0.5);

P_46_autobus_foraneo_2006[i]=
quantile(precios_46_autobus_foraneo[i]*selif(inpc_46_autobus_foraneo, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_autobus_foraneo, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_transporte_aereo_2006[i]=
quantile(precios_46_transporte_aereo[i]*selif(inpc_46_transporte_aereo, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .ge fecha_inicial_2006).*(inpc_46_fecha .le fecha_final_2006))./selif(inpc_46_transporte_aereo, (inpc_46_estado .eq precios_46_estado[i]).*(inpc_46_municipio .eq precios_46_municipio[i]).*(inpc_46_fecha .eq fecha_2011)), 0.5);

P_46_materiales_2006[i]=
quantile(precios_46_materiales[i]*selif(inpp_mat_46_materiales, (inpp_mat_46_estado .eq precios_46_estado[i]).*(inpp_mat_46_municipio .eq precios_46_municipio[i]).*(inpp_mat_46_fecha .ge fecha_inicial_2006).*(inpp_mat_46_fecha .le fecha_final_2006))./selif(inpp_mat_46_materiales, (inpp_mat_46_estado .eq precios_46_estado[i]).*(inpp_mat_46_municipio .eq precios_46_municipio[i]).*(inpp_mat_46_fecha .eq fecha_2011)), 0.5);
...
load gastos_hogares_1[400000,3]=gasto_hogar_enigh_2006_archivo_1.asc;
load gastos_hogares_2[400000,3]=gasto_hogar_enigh_2006_archivo_2.asc;
load gastos_hogares_3[548530,3]=gasto_hogar_enigh_2006_archivo_3.asc;

gastos_hogares=gastos_hogares_1|gastos_hogares_2|gastos_hogares_3;

/*VARIABLES:
1.- folioviv: Identificador de la vivienda (eliminamos ya todas las viviendas con multiples hogares)	
...
load vars_concentrado_hogares[20875,115]=datos_concentrado_hogares_enigh_2006.asc;
...
115. clave_municipio
*/
ratio_2006=((vars_concentrado_hogares[.,53]+vars_concentrado_hogares[.,86]+vars_concentrado_hogares[.,87]+vars_concentrado_hogares[.,103])./vars_concentrado_hogares[.,52]);
ratio_2006_below_median=selif(ratio_2006, vars_concentrado_hogares[.,52] .le quantile(vars_concentrado_hogares[.,52], 0.5));
ingreso_2006_GINI=sortc(vars_concentrado_hogares[.,24],1);
entidad_federativa_GINI=vars_concentrado_hogares[.,114];
...
regiones_GINI_2006=region_noroeste_GINI~region_noreste_GINI~region_centro_norte_GINI~region_centro_sur_GINI~region_suroeste_GINI~region_sureste_GINI~region_oeste_GINI~region_este_GINI;
ingreso_2006_GINI_noroeste=selif(ingreso_2006_GINI, region_noroeste_GINI);
ingreso_2006_GINI_noreste=selif(ingreso_2006_GINI, region_noreste_GINI);
ingreso_2006_GINI_centro_norte=selif(ingreso_2006_GINI, region_centro_norte_GINI);
ingreso_2006_GINI_centro_sur=selif(ingreso_2006_GINI, region_centro_sur_GINI);
ingreso_2006_GINI_suroeste=selif(ingreso_2006_GINI, region_suroeste_GINI);
ingreso_2006_GINI_sureste=selif(ingreso_2006_GINI, region_sureste_GINI);
ingreso_2006_GINI_oeste=selif(ingreso_2006_GINI, region_oeste_GINI);
ingreso_2006_GINI_este=selif(ingreso_2006_GINI, region_este_GINI);
ingreso_2006_GINI_noroeste=sortc(ingreso_2006_GINI_noroeste,1);
ingreso_2006_GINI_noreste=sortc(ingreso_2006_GINI_noreste,1);
ingreso_2006_GINI_centro_norte=sortc(ingreso_2006_GINI_centro_norte,1);
ingreso_2006_GINI_centro_sur=sortc(ingreso_2006_GINI_centro_sur,1);
ingreso_2006_GINI_suroeste=sortc(ingreso_2006_GINI_suroeste,1);
ingreso_2006_GINI_sureste=sortc(ingreso_2006_GINI_sureste,1);
ingreso_2006_GINI_oeste=sortc(ingreso_2006_GINI_oeste,1);
ingreso_2006_GINI_este=sortc(ingreso_2006_GINI_este,1);

load tenencia_vivienda[20875,2]=hogares_tenencia_vivienda_2006.asc;
clave_vivienda_tenencia=tenencia_vivienda[.,1];
tenencia_estatus=tenencia_vivienda[.,2];
tenencia_estatus=((tenencia_estatus .eq 4)+(tenencia_estatus .eq 5) .gt 0);
...
i=i+1;
endo;
clase_de_hogar=vars_concentrado_hogares[.,5];
edad_del_jefe=vars_concentrado_hogares[.,6];
total_integrantes=vars_concentrado_hogares[.,11];
gasto_monetario=vars_concentrado_hogares[.,52];
/*
1.-	Clave_Estado
2.-	Clave_Municipio
3.-	Latitud (en grados)
...
70.-Transporte Aereo (M003)->(13003)
*/
vars_concentrado_hogares=selif(vars_concentrado_hogares, (vivienda_propia .gt 0).*(clase_de_hogar .le 5).*(edad_del_jefe .ge 20).*(edad_del_jefe .le 75).*(total_integrantes .le 8).*(gasto_monetario .ge quantile(gasto_monetario,0.01)));
clave_vivienda_concentrados=vars_concentrado_hogares[.,1]; 
num_hogares=rows(clave_vivienda_concentrados);
estado_hogar=vars_concentrado_hogares[.,114];
municipio_hogar=vars_concentrado_hogares[.,115];
...
poblacion_hogares_46_ciudades=aux_ciudades~sumc((ciudad_46_mas_cercana .eq aux_ciudades'));
...
clave_vivienda_concentrados=vars_concentrado_hogares[.,1]; 
num_hogares=rows(clave_vivienda_concentrados);
P_hogar_tortillas_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_pan_blanco_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_pan_dulce_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_pollo_entero_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_pollo_piezas_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_huevo_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_bistec_res_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_molida_res_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_visceras_res_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_chorizo_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_jamon_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_salchichas_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_tocino_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_leche_pasteurizada_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_leche_en_polvo_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_leche_maternizada_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_leche_condensada_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_queso_fresco_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_queso_oaxaca_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_queso_amarillo_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_crema_de_leche_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_mantequilla_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_manzana_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_platanos_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_aguacate_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_papaya_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_naranja_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_limon_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_melon_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_uvas_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_pera_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_guayaba_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_sandia_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_pina_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_jitomate_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_papa_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_cebolla_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_tomate_verde_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_col_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_lechuga_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_calabacita_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_zanahoria_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_chile_serrano_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_nopales_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_chayote_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_chile_poblano_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_pepino_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_ejotes_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_chicharo_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_frijol_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_jugos_nectares_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_refrescos_envasados_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_agua_embotellada_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_antibioticos_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_cardiovasculares_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_analgesicos_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_nutricionales_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_gastrointestinales_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_antigripales_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_medicinas_tos_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_medicinas_piel_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_autobus_foraneo_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_transporte_aereo_2006=zeros(rows(vars_concentrado_hogares),1);
P_hogar_materiales_2006=zeros(rows(vars_concentrado_hogares),1);

i=1;
do while i .le rows(vars_concentrado_hogares);
rr=ciudad_46_mas_cercana[i];
P_hogar_tortillas_2006[i]=P_46_tortillas_2006[rr];
P_hogar_pan_blanco_2006[i]=P_46_pan_blanco_2006[rr];
P_hogar_pan_dulce_2006[i]=P_46_pan_dulce_2006[rr];
P_hogar_pollo_entero_2006[i]=P_46_pollo_entero_2006[rr];
P_hogar_pollo_piezas_2006[i]=P_46_pollo_piezas_2006[rr];
P_hogar_huevo_2006[i]=P_46_huevo_2006[rr];
P_hogar_bistec_res_2006[i]=P_46_bistec_res_2006[rr];
P_hogar_molida_res_2006[i]=P_46_molida_res_2006[rr];
P_hogar_visceras_res_2006[i]=P_46_visceras_res_2006[rr];
P_hogar_chorizo_2006[i]=P_46_chorizo_2006[rr];
P_hogar_jamon_2006[i]=P_46_jamon_2006[rr];
P_hogar_salchichas_2006[i]=P_46_salchichas_2006[rr];
P_hogar_tocino_2006[i]=P_46_tocino_2006[rr];
P_hogar_leche_pasteurizada_2006[i]=P_46_leche_pasteurizada_2006[rr];
P_hogar_leche_en_polvo_2006[i]=P_46_leche_en_polvo_2006[rr];
P_hogar_leche_maternizada_2006[i]=P_46_leche_maternizada_2006[rr];
P_hogar_leche_condensada_2006[i]=P_46_leche_condensada_2006[rr];
P_hogar_queso_fresco_2006[i]=P_46_queso_fresco_2006[rr];
P_hogar_queso_oaxaca_2006[i]=P_46_queso_oaxaca_2006[rr];
P_hogar_queso_amarillo_2006[i]=P_46_queso_amarillo_2006[rr];
P_hogar_crema_de_leche_2006[i]=P_46_crema_de_leche_2006[rr];
P_hogar_mantequilla_2006[i]=P_46_mantequilla_2006[rr];
P_hogar_manzana_2006[i]=P_46_manzana_2006[rr];
P_hogar_platanos_2006[i]=P_46_platanos_2006[rr];
P_hogar_aguacate_2006[i]=P_46_aguacate_2006[rr];
P_hogar_papaya_2006[i]=P_46_papaya_2006[rr];
P_hogar_naranja_2006[i]=P_46_naranja_2006[rr];
P_hogar_limon_2006[i]=P_46_limon_2006[rr];
P_hogar_melon_2006[i]=P_46_melon_2006[rr];
P_hogar_uvas_2006[i]=P_46_uvas_2006[rr];
P_hogar_pera_2006[i]=P_46_pera_2006[rr];
P_hogar_guayaba_2006[i]=P_46_guayaba_2006[rr];
P_hogar_sandia_2006[i]=P_46_sandia_2006[rr];
P_hogar_pina_2006[i]=P_46_pina_2006[rr];
P_hogar_jitomate_2006[i]=P_46_jitomate_2006[rr];
P_hogar_papa_2006[i]=P_46_papa_2006[rr];
P_hogar_cebolla_2006[i]=P_46_cebolla_2006[rr];
P_hogar_tomate_verde_2006[i]=P_46_tomate_verde_2006[rr];
P_hogar_col_2006[i]=P_46_col_2006[rr];
P_hogar_lechuga_2006[i]=P_46_lechuga_2006[rr];
P_hogar_calabacita_2006[i]=P_46_calabacita_2006[rr];
P_hogar_zanahoria_2006[i]=P_46_zanahoria_2006[rr];
P_hogar_chile_serrano_2006[i]=P_46_chile_serrano_2006[rr];
P_hogar_nopales_2006[i]=P_46_nopales_2006[rr];
P_hogar_chayote_2006[i]=P_46_chayote_2006[rr];
P_hogar_chile_poblano_2006[i]=P_46_chile_poblano_2006[rr];
P_hogar_pepino_2006[i]=P_46_pepino_2006[rr];
P_hogar_ejotes_2006[i]=P_46_ejotes_2006[rr];
P_hogar_chicharo_2006[i]=P_46_chicharo_2006[rr];
P_hogar_frijol_2006[i]=P_46_frijol_2006[rr];
P_hogar_jugos_nectares_2006[i]=P_46_jugos_nectares_2006[rr];
P_hogar_refrescos_envasados_2006[i]=P_46_refrescos_envasados_2006[rr];
P_hogar_agua_embotellada_2006[i]=P_46_agua_embotellada_2006[rr];
P_hogar_antibioticos_2006[i]=P_46_antibioticos_2006[rr];
P_hogar_cardiovasculares_2006[i]=P_46_cardiovasculares_2006[rr];
P_hogar_analgesicos_2006[i]=P_46_analgesicos_2006[rr];
P_hogar_nutricionales_2006[i]=P_46_nutricionales_2006[rr];
P_hogar_gastrointestinales_2006[i]=P_46_gastrointestinales_2006[rr];
P_hogar_antigripales_2006[i]=P_46_antigripales_2006[rr];
P_hogar_medicinas_tos_2006[i]=P_46_medicinas_tos_2006[rr];
P_hogar_medicinas_piel_2006[i]=P_46_medicinas_piel_2006[rr];
P_hogar_autobus_foraneo_2006[i]=P_46_autobus_foraneo_2006[rr];
P_hogar_transporte_aereo_2006[i]=P_46_transporte_aereo_2006[rr];
P_hogar_materiales_2006[i]=P_46_materiales_2006[rr];
i=i+1;
endo;
/*
...
gastos_hogares_materiales[i]=selif(vars_concentrado_hogares[.,103], clave_vivienda_concentrados .eq hogar_en_turno);	
...
vector_gastos_hogares[i,.]=(g_hogar)';
...
/*1.- TORTILLAS*/
precios_hogar_tortillas=P_hogar_tortillas_2006;
...
precios_hogar_pan=(1/k_PAN)*((P_hogar_pan_blanco_2006./w_pan_blanco).^w_pan_blanco).*((P_hogar_pan_dulce_2006./w_pan_dulce).^w_pan_dulce);
...
precios_hogar_pollo_huevo=(1/k_POLLO_HUEVO)*((P_hogar_pollo_entero_2006./w_pollo_entero).^w_pollo_entero).*((P_hogar_pollo_piezas_2006./w_pollo_piezas).^w_pollo_piezas)
.*((P_hogar_huevo_2006./w_huevo).^w_huevo);
...
precios_hogar_carne_res=(1/k_CARNE_RES)*((P_hogar_bistec_res_2006./w_bistec_res).^w_bistec_res).*((P_hogar_molida_res_2006./w_molida_res).^w_molida_res)
.*((P_hogar_visceras_res_2006./w_visceras_res).^w_visceras_res);
...
precios_hogar_carnes_procesadas=(1/k_CARNES_PROCESADAS)*((P_hogar_chorizo_2006./w_chorizo).^w_chorizo).*((P_hogar_jamon_2006./w_jamon).^w_jamon)
.*((P_hogar_salchichas_2006./w_salchichas).^w_salchichas).*((P_hogar_tocino_2006./w_tocino).^w_tocino);
...
precios_hogar_lacteos=(1/k_LACTEOS)*((P_hogar_leche_pasteurizada_2006./w_leche_pasteur).^w_leche_pasteur).*((P_hogar_leche_en_polvo_2006./w_leche_en_polvo).^w_leche_en_polvo)
.*((P_hogar_leche_maternizada_2006./w_leche_maternizada).^w_leche_maternizada).*((P_hogar_leche_condensada_2006./w_leche_condensada).^w_leche_condensada)
.*((P_hogar_queso_fresco_2006./w_queso_fresco).^w_queso_fresco).*((P_hogar_queso_oaxaca_2006./w_queso_oaxaca).^w_queso_oaxaca).*((P_hogar_queso_amarillo_2006./w_queso_amarillo).^w_queso_amarillo)
.*((P_hogar_crema_de_leche_2006./w_crema_leche).^w_crema_leche).*((P_hogar_mantequilla_2006./w_mantequilla).^w_mantequilla);
...
precios_hogar_frutas=(1/k_FRUTAS)*((P_hogar_manzana_2006./w_manzana).^w_manzana).*((P_hogar_platanos_2006./w_platano).^w_platano).*((P_hogar_papaya_2006./w_papaya).^w_papaya)
.*((P_hogar_naranja_2006./w_naranja).^w_naranja).*((P_hogar_limon_2006./w_limon).^w_limon).*((P_hogar_melon_2006./w_melon).^w_melon)
.*((P_hogar_uvas_2006./w_uvas).^w_uvas).*((P_hogar_pera_2006./w_pera).^w_pera).*((P_hogar_guayaba_2006./w_guayaba).^w_guayaba)
.*((P_hogar_sandia_2006./w_sandia).^w_sandia).*((P_hogar_pina_2006./w_pina).^w_pina);
...
precios_hogar_verduras=(1/k_VERDURAS)*((P_hogar_aguacate_2006./w_aguacate).^w_aguacate).*((P_hogar_jitomate_2006./w_jitomate).^w_jitomate)
.*((P_hogar_papa_2006./w_papa).^w_papa).*((P_hogar_cebolla_2006./w_cebolla).^w_cebolla)
.*((P_hogar_tomate_verde_2006./w_tomate_verde).^w_tomate_verde).*((P_hogar_col_2006./w_col).^w_col)
.*((P_hogar_lechuga_2006./w_lechuga).^w_lechuga).*((P_hogar_calabacita_2006./w_calabacita).^w_calabacita)
.*((P_hogar_zanahoria_2006./w_zanahoria).^w_zanahoria).*((P_hogar_chile_serrano_2006./w_chile_serrano).^w_chile_serrano)
.*((P_hogar_nopales_2006./w_nopales).^w_nopales).*((P_hogar_chayote_2006./w_chayote).^w_chayote)
.*((P_hogar_chile_poblano_2006./w_chile_poblano).^w_chile_poblano).*((P_hogar_pepino_2006./w_pepino).^w_pepino)
.*((P_hogar_ejotes_2006./w_ejotes).^w_ejotes).*((P_hogar_chicharo_2006./w_chicharo).^w_chicharo)
.*((P_hogar_frijol_2006./w_frijol).^w_frijol);
...
precios_hogar_bebidas=(1/k_BEBIDAS)*((P_hogar_jugos_nectares_2006./w_jugos).^w_jugos)
.*((P_hogar_refrescos_envasados_2006./w_refrescos).^w_refrescos)
.*((P_hogar_agua_embotellada_2006./w_agua).^w_agua);
...
precios_hogar_medicinas=(1/k_MEDICINAS)*((P_hogar_antibioticos_2006./w_antibioticos).^w_antibioticos)
.*((P_hogar_cardiovasculares_2006./w_cardiovasculares).^w_cardiovasculares)
.*((P_hogar_analgesicos_2006./w_analgesicos).^w_analgesicos)
.*((P_hogar_nutricionales_2006./w_nutricionales).^w_nutricionales)
.*((P_hogar_gastrointestinales_2006./w_gastrointestinales).^w_gastrointestinales)
.*((P_hogar_antigripales_2006./w_antigripales).^w_antigripales)
.*((P_hogar_medicinas_tos_2006./w_tos).^w_tos)
.*((P_hogar_medicinas_piel_2006./w_dermatologicos).^w_dermatologicos);
...
precios_hogar_transporte_foraneo=(1/k_TRANSPORTE)*((P_hogar_autobus_foraneo_2006./w_autobus_foraneo).^w_autobus_foraneo)
.*((P_hogar_transporte_aereo_2006./w_transporte_aereo).^w_transporte_aereo);

/*12.- MATERIALES*/
precios_hogar_materiales=P_hogar_materiales_2006;

categorias_relevantes_por_hogar=
(gasto_hogar_tortillas .ge 10)+(gasto_hogar_pan .ge 10)+(gasto_hogar_pollo_huevo .ge 10)+(gasto_hogar_carne_res .ge 10)
+(gasto_hogar_carnes_procesadas .ge 10)+(gasto_hogar_lacteos .ge 10)+(gasto_hogar_frutas .ge 10)+(gasto_hogar_verduras .ge 10)
+(gasto_hogar_bebidas .ge 10)+(gasto_hogar_medicinas .ge 10)+(gasto_hogar_transporte_foraneo .ge 10)
+(gasto_hogar_materiales .ge 10);
...
P_hogar_autobus_foraneo_2006=selif(P_hogar_autobus_foraneo_2006, categorias_relevantes_por_hogar .ge n_categ_min); /*NUEVO CODIGO AGREGADO ENERO 6 2016*/
P_hogar_transporte_aereo_2006=selif(P_hogar_transporte_aereo_2006, categorias_relevantes_por_hogar .ge n_categ_min); /*NUEVO CODIGO AGREGADO ENERO 6 2016*/
...
load hogares_lavadoras[20875,2]=hogares_lavadoras_ENIGH_2006.asc;
...
load hogares_vehiculos[20875,2]=hogares_vehiculos_ENIGH_2006.asc;
...
load sexo_jefe_familia[20875,2]=sexo_jefe_familia_ENIGH_2006.asc;
clave_hogar_sexo_jefe=sexo_jefe_familia[.,1];
genero_jefe_familia=sexo_jefe_familia[.,2]; /*1=hombre, 2=mujer*/
sexo_jefe_de_familia=zeros(num_hogares,1);

i=1;
do while i .le num_hogares;
hogar_en_turno=clave_vivienda_concentrados[i];
aux_sexo_jefe=selif(genero_jefe_familia, clave_hogar_sexo_jefe .eq hogar_en_turno);
sexo_jefe_de_familia[i]=aux_sexo_jefe;
i=i+1;
endo;	

jefe_de_familia_mujer=(sexo_jefe_de_familia .eq 2); 
...
precio_autobus_foraneo=P_hogar_autobus_foraneo_2006; /*NUEVO CODIGO AGREGADO ENERO 6 2016*/
precio_transporte_aereo=P_hogar_transporte_aereo_2006; /*NUEVO CODIGO AGREGADO ENERO 6 2016*/
...
Z5=(vars_concentrado_hogares[.,22] .ge quantile(vars_concentrado_hogares[.,22], 8/10)); 
Z6=Z1.*Z4;
Z7=Z1^2;
Z8=(vars_concentrado_hogares[.,3] .eq 4);
Z9=hogar_tiene_vehiculo.*hogar_tiene_lavadora; /*Indicadora: 1 si hogar posee vehiculo*/
...
elastic_46_ciudades_matrix_bis=zeros(46,14);
...
/*INICIA NUEVO CODIGO AGREGADO ENERO 6 2016*/
if pfp .ge 13;
categ_counterf=11;
endif;  
if pfp .eq 13;
...
/*TERMINA NUEVO CODIGO AGREGADO ENERO 6 2016*/
...
elastic_demanda_46_ciudades_fin=(ln(sumc(aux_dem_contrafactual))-ln(sumc(aux_dem_original)))./ln(meanc(factor_contrafactual));
...
elastic_46_ciudades_matrix_bis[.,pfp]=elastic_demanda_46_ciudades_fin;
...
3.- Ãrea Met. de la Cd. de MÃ©xico
4.- Campeche, Camp.
5.- Cd. AcuÃ±a, Coah.
6.- Cd. JuÃ¡rez, Chih.
7.- Chetumal, Q. Roo.
...
31.- Puebla, Pue.
32.- QuerÃ©taro, Qro.
33.- San AndrÃ©s Tuxtla, Ver.
34.- San Luis PotosÃ­, S.L.P.
35.- Tampico, Tamps.
36.- Tapachula, Chis.
37.- Tehuantepec, Oax.
38.- TepatitlÃ¡n, Jal.
...
poblacion_total_46_ciudades=poblacion_total_46_ciudades/1000; /*Poblacion de las 46 ciudades en miles de habitantes*/
/*
1.- Personal ocupado total   
2.- Personal remunerado total 
3.- Total de remuneraciones (miles de pesos) 
4.- ProducciÃÂ³n bruta total (miles de pesos)ÃÂ  
5.- Consumo intermedio (miles de pesos)ÃÂ  
6.- Valor agregado censal bruto (miles de pesos) 
7.- Acervo total de activos fijos (miles de pesos)ÃÂ   
8.- DepreciaciÃÂ³n total de activos fijos (miles de pesos)  
9.-InversiÃÂ³n total (miles de pesos) 
10.- Unidades econÃÂ³micas
11.- Total de gastos (miles de pesos)  
*/	

load variables_costos_2004[46,11]=indicadores_costos_censos_economicos_2004.asc; 
unidades_economicas=variables_costos_2004[.,10];
empleados_por_UE=variables_costos_2004[.,1]./unidades_economicas;
empleados_remunerados_por_UE=variables_costos_2004[.,2]./unidades_economicas;
remuneraciones_por_UE=variables_costos_2004[.,3]./unidades_economicas;
produccion_bruta_por_UE=variables_costos_2004[.,4]./unidades_economicas;
consumo_intermedio_por_UE=variables_costos_2004[.,5]./unidades_economicas;
activos_fijos_por_UE=variables_costos_2004[.,7]./unidades_economicas;
depreciacion_activos_por_UE=variables_costos_2004[.,8]./unidades_economicas;
total_gastos_por_UE=variables_costos_2004[.,11]./unidades_economicas;
valor_agregado_por_empleado=variables_costos_2004[.,6]./variables_costos_2004[.,1];
valor_agregado_por_activos=variables_costos_2004[.,6]./variables_costos_2004[.,7];
valor_agregado_por_unidad=variables_costos_2004[.,6]./variables_costos_2004[.,10];
...
/*1.- TORTILLAS*/
precio_promedio_tortillas=P_46_tortillas_2006;

/*2.- PAN*/
precio_promedio_pan=sumc((P_46_pan_blanco_2006*meanc(w_pan_blanco)~P_46_pan_dulce_2006*meanc(w_pan_dulce))');

/*3.- POLLO Y HUEVO*/
precio_promedio_pollo_huevo=sumc((P_46_pollo_entero_2006*meanc(w_pollo_entero)~P_46_pollo_piezas_2006*meanc(w_pollo_piezas)
~P_46_huevo_2006*meanc(w_huevo))');

/*4.- CARNE DE RES*/
precio_promedio_carne_res=sumc((P_46_bistec_res_2006*meanc(w_bistec_res)~P_46_molida_res_2006*meanc(w_molida_res)~
P_46_visceras_res_2006*meanc(w_visceras_res))');

/*5.- CARNES PROCESADAS*/
precio_promedio_carnes_proc=sumc((P_46_chorizo_2006*meanc(w_chorizo)~P_46_jamon_2006*meanc(w_jamon)~
P_46_salchichas_2006*meanc(w_salchichas)~P_46_tocino_2006*meanc(w_tocino))');

/*6.- LACTEOS*/
precio_promedio_lacteos=sumc((P_46_leche_pasteurizada_2006*meanc(w_leche_pasteur)~P_46_leche_en_polvo_2006*meanc(w_leche_en_polvo)~
P_46_leche_maternizada_2006*meanc(w_leche_maternizada)~P_46_leche_condensada_2006*meanc(w_leche_condensada)~
P_46_queso_fresco_2006*meanc(w_queso_fresco)~P_46_queso_oaxaca_2006*meanc(w_queso_oaxaca)~P_46_queso_amarillo_2006*meanc(w_queso_amarillo)
~P_46_crema_de_leche_2006*meanc(w_crema_leche)~P_46_mantequilla_2006*meanc(w_mantequilla))');

/* 7.- FRUTAS*/
precio_promedio_frutas=sumc((P_46_manzana_2006*meanc(w_manzana)~P_46_platanos_2006*meanc(w_platano)~
P_46_aguacate_2006*meanc(w_aguacate)~P_46_papaya_2006*meanc(w_papaya)~P_46_naranja_2006*meanc(w_naranja)~
P_46_limon_2006*meanc(w_limon)~P_46_melon_2006*meanc(w_melon)~P_46_uvas_2006*meanc(w_uvas)~P_46_pera_2006*meanc(w_pera)
~P_46_guayaba_2006*meanc(w_guayaba)~P_46_sandia_2006*meanc(w_sandia)~P_46_pina_2006*meanc(w_pina))');

/*8.- VERDURAS*/
precio_promedio_verduras=sumc((P_46_jitomate_2006*meanc(w_jitomate)~P_46_papa_2006*meanc(w_papa)~P_46_cebolla_2006*meanc(w_cebolla)
~P_46_tomate_verde_2006*meanc(w_tomate_verde)~P_46_col_2006*meanc(w_col)~P_46_lechuga_2006*meanc(w_lechuga)~
P_46_calabacita_2006*meanc(w_calabacita)~P_46_zanahoria_2006*meanc(w_zanahoria)~P_46_chile_serrano_2006*meanc(w_chile_serrano)
~P_46_nopales_2006*meanc(w_nopales)~P_46_chayote_2006*meanc(w_chayote)~P_46_chile_poblano_2006*meanc(w_chile_poblano)~
P_46_pepino_2006*meanc(w_pepino)~P_46_ejotes_2006*meanc(w_ejotes)~P_46_chicharo_2006*meanc(w_chicharo)~P_46_frijol_2006*meanc(w_frijol))');

/* 9.- BEBIDAS*/
precio_promedio_bebidas=sumc((P_46_jugos_nectares_2006*meanc(w_jugos)~P_46_refrescos_envasados_2006*meanc(w_refrescos)
~P_46_agua_embotellada_2006*meanc(w_agua))');

/* 10.- MEDICAMENTOS*/
precio_promedio_medicinas=sumc((P_46_antibioticos_2006*meanc(w_antibioticos)~P_46_cardiovasculares_2006*meanc(w_cardiovasculares)
~P_46_analgesicos_2006*meanc(w_analgesicos)~P_46_nutricionales_2006*meanc(w_nutricionales)~
P_46_gastrointestinales_2006*meanc(w_gastrointestinales)~P_46_antigripales_2006*meanc(w_antigripales)
~P_46_medicinas_tos_2006*meanc(w_tos)~P_46_medicinas_piel_2006*meanc(w_dermatologicos))');

/* 11.- TRANSPORTE FORANEO*/
precio_promedio_transporte=sumc((P_46_autobus_foraneo_2006*meanc(w_autobus_foraneo)~P_46_transporte_aereo_2006*meanc(w_transporte_aereo))');

/*12.- MATERIALES*/
precio_promedio_materiales=P_46_materiales_2006;

/*13.- TRANSPORTE AEREO*/
precio_promedio_aereo=P_46_transporte_aereo_2006;

/*14.- AUTOBUS FORANEO*/
precio_promedio_foraneo=P_46_autobus_foraneo_2006;
...
markup_promedio_46_ciudades_2006=meanc(markup_costo_46_ciudades');	
median_markup_46_ciudades_2006=quantile(markup_costo_46_ciudades',0.5)';
...
VC_markups_2006=costo_p1_y_p0-costo_p0_y_p0;
VE_markups_2006=costo_p1_y_p1-costo_p0_y_p1;

VE_2006=((costo_p1_y_p1-costo_p0_y_p1)./costo_p1_y_p1).*suma_gastos;

VE_ingr_2006=VE_2006./vars_concentrado_hogares[.,22];

VE_2006_todo_pais=quantile(VE_2006, 0.5);
VE_2006_decil_10_todo_pais=quantile(selif(VE_2006, decil_10_hogares), 0.5);
VE_2006_decil_20_todo_pais=quantile(selif(VE_2006, decil_20_hogares), 0.5);
VE_2006_decil_30_todo_pais=quantile(selif(VE_2006, decil_30_hogares), 0.5);
VE_2006_decil_40_todo_pais=quantile(selif(VE_2006, decil_40_hogares), 0.5);
VE_2006_decil_50_todo_pais=quantile(selif(VE_2006, decil_50_hogares), 0.5);
VE_2006_decil_60_todo_pais=quantile(selif(VE_2006, decil_60_hogares), 0.5);
VE_2006_decil_70_todo_pais=quantile(selif(VE_2006, decil_70_hogares), 0.5);
VE_2006_decil_80_todo_pais=quantile(selif(VE_2006, decil_80_hogares), 0.5);
VE_2006_decil_90_todo_pais=quantile(selif(VE_2006, decil_90_hogares), 0.5);
VE_2006_decil_100_todo_pais=quantile(selif(VE_2006, decil_100_hogares), 0.5);

VE_2006_debajo_decil_50=quantile(selif(VE_2006, pordebajo_decil_50_hogares), 0.5);

VE_ingr_2006_todo_pais=quantile(VE_ingr_2006, 0.5);

VE_ingr_2006_d_10_todo_pais=quantile(selif(VE_ingr_2006, decil_10_hogares), 0.5);
VE_ingr_2006_d_20_todo_pais=quantile(selif(VE_ingr_2006, decil_20_hogares), 0.5);
VE_ingr_2006_d_30_todo_pais=quantile(selif(VE_ingr_2006, decil_30_hogares), 0.5);
VE_ingr_2006_d_40_todo_pais=quantile(selif(VE_ingr_2006, decil_40_hogares), 0.5);
VE_ingr_2006_d_50_todo_pais=quantile(selif(VE_ingr_2006, decil_50_hogares), 0.5);
VE_ingr_2006_d_60_todo_pais=quantile(selif(VE_ingr_2006, decil_60_hogares), 0.5);
VE_ingr_2006_d_70_todo_pais=quantile(selif(VE_ingr_2006, decil_70_hogares), 0.5);
VE_ingr_2006_d_80_todo_pais=quantile(selif(VE_ingr_2006, decil_80_hogares), 0.5);
VE_ingr_2006_d_90_todo_pais=quantile(selif(VE_ingr_2006, decil_90_hogares), 0.5);
VE_ingr_2006_d_100_todo_pais=quantile(selif(VE_ingr_2006, decil_100_hogares), 0.5);

VE_ingr_2006_debajo_decil_50=quantile(selif(VE_ingr_2006, pordebajo_decil_50_hogares), 0.5);
...
VE_2006_noroeste=quantile(selif(VE_2006, hogar_region_noroeste), 0.5);
VE_2006_d_10_noroeste=quantile(selif(VE_2006, hogar_region_noroeste.*decil_10_noroeste), 0.5);
VE_2006_d_20_noroeste=quantile(selif(VE_2006, hogar_region_noroeste.*decil_20_noroeste), 0.5);
VE_2006_d_30_noroeste=quantile(selif(VE_2006, hogar_region_noroeste.*decil_30_noroeste), 0.5);
VE_2006_d_40_noroeste=quantile(selif(VE_2006, hogar_region_noroeste.*decil_40_noroeste), 0.5);
VE_2006_d_50_noroeste=quantile(selif(VE_2006, hogar_region_noroeste.*decil_50_noroeste), 0.5);
VE_2006_d_60_noroeste=quantile(selif(VE_2006, hogar_region_noroeste.*decil_60_noroeste), 0.5);
VE_2006_d_70_noroeste=quantile(selif(VE_2006, hogar_region_noroeste.*decil_70_noroeste), 0.5);
VE_2006_d_80_noroeste=quantile(selif(VE_2006, hogar_region_noroeste.*decil_80_noroeste), 0.5);
VE_2006_d_90_noroeste=quantile(selif(VE_2006, hogar_region_noroeste.*decil_90_noroeste), 0.5);
VE_2006_d_100_noroeste=quantile(selif(VE_2006, hogar_region_noroeste.*decil_100_noroeste), 0.5);

VE_2006_noreste=quantile(selif(VE_2006, hogar_region_noreste), 0.5);
VE_2006_d_10_noreste=quantile(selif(VE_2006, hogar_region_noreste.*decil_10_noreste), 0.5);
VE_2006_d_20_noreste=quantile(selif(VE_2006, hogar_region_noreste.*decil_20_noreste), 0.5);
VE_2006_d_30_noreste=quantile(selif(VE_2006, hogar_region_noreste.*decil_30_noreste), 0.5);
VE_2006_d_40_noreste=quantile(selif(VE_2006, hogar_region_noreste.*decil_40_noreste), 0.5);
VE_2006_d_50_noreste=quantile(selif(VE_2006, hogar_region_noreste.*decil_50_noreste), 0.5);
VE_2006_d_60_noreste=quantile(selif(VE_2006, hogar_region_noreste.*decil_60_noreste), 0.5);
VE_2006_d_70_noreste=quantile(selif(VE_2006, hogar_region_noreste.*decil_70_noreste), 0.5);
VE_2006_d_80_noreste=quantile(selif(VE_2006, hogar_region_noreste.*decil_80_noreste), 0.5);
VE_2006_d_90_noreste=quantile(selif(VE_2006, hogar_region_noreste.*decil_90_noreste), 0.5);
VE_2006_d_100_noreste=quantile(selif(VE_2006, hogar_region_noreste.*decil_100_noreste), 0.5);

VE_2006_centro_norte=quantile(selif(VE_2006, hogar_region_centro_norte), 0.5);
VE_2006_d_10_centro_norte=quantile(selif(VE_2006, hogar_region_centro_norte.*decil_10_centro_norte), 0.5);
VE_2006_d_20_centro_norte=quantile(selif(VE_2006, hogar_region_centro_norte.*decil_20_centro_norte), 0.5);
VE_2006_d_30_centro_norte=quantile(selif(VE_2006, hogar_region_centro_norte.*decil_30_centro_norte), 0.5);
VE_2006_d_40_centro_norte=quantile(selif(VE_2006, hogar_region_centro_norte.*decil_40_centro_norte), 0.5);
VE_2006_d_50_centro_norte=quantile(selif(VE_2006, hogar_region_centro_norte.*decil_50_centro_norte), 0.5);
VE_2006_d_60_centro_norte=quantile(selif(VE_2006, hogar_region_centro_norte.*decil_60_centro_norte), 0.5);
VE_2006_d_70_centro_norte=quantile(selif(VE_2006, hogar_region_centro_norte.*decil_70_centro_norte), 0.5);
VE_2006_d_80_centro_norte=quantile(selif(VE_2006, hogar_region_centro_norte.*decil_80_centro_norte), 0.5);
VE_2006_d_90_centro_norte=quantile(selif(VE_2006, hogar_region_centro_norte.*decil_90_centro_norte), 0.5);
VE_2006_d_100_centro_norte=quantile(selif(VE_2006, hogar_region_centro_norte.*decil_100_centro_norte), 0.5);


VE_2006_centro_sur=quantile(selif(VE_2006, hogar_region_centro_sur), 0.5);
VE_2006_d_10_centro_sur=quantile(selif(VE_2006, hogar_region_centro_sur.*decil_10_centro_sur), 0.5);
VE_2006_d_20_centro_sur=quantile(selif(VE_2006, hogar_region_centro_sur.*decil_20_centro_sur), 0.5);
VE_2006_d_30_centro_sur=quantile(selif(VE_2006, hogar_region_centro_sur.*decil_30_centro_sur), 0.5);
VE_2006_d_40_centro_sur=quantile(selif(VE_2006, hogar_region_centro_sur.*decil_40_centro_sur), 0.5);
VE_2006_d_50_centro_sur=quantile(selif(VE_2006, hogar_region_centro_sur.*decil_50_centro_sur), 0.5);
VE_2006_d_60_centro_sur=quantile(selif(VE_2006, hogar_region_centro_sur.*decil_60_centro_sur), 0.5);
VE_2006_d_70_centro_sur=quantile(selif(VE_2006, hogar_region_centro_sur.*decil_70_centro_sur), 0.5);
VE_2006_d_80_centro_sur=quantile(selif(VE_2006, hogar_region_centro_sur.*decil_80_centro_sur), 0.5);
VE_2006_d_90_centro_sur=quantile(selif(VE_2006, hogar_region_centro_sur.*decil_90_centro_sur), 0.5);
VE_2006_d_100_centro_sur=quantile(selif(VE_2006, hogar_region_centro_sur.*decil_100_centro_sur), 0.5);

VE_2006_suroeste=quantile(selif(VE_2006, hogar_region_suroeste), 0.5);
VE_2006_d_10_suroeste=quantile(selif(VE_2006, hogar_region_suroeste.*decil_10_suroeste), 0.5);
VE_2006_d_20_suroeste=quantile(selif(VE_2006, hogar_region_suroeste.*decil_20_suroeste), 0.5);
VE_2006_d_30_suroeste=quantile(selif(VE_2006, hogar_region_suroeste.*decil_30_suroeste), 0.5);
VE_2006_d_40_suroeste=quantile(selif(VE_2006, hogar_region_suroeste.*decil_40_suroeste), 0.5);
VE_2006_d_50_suroeste=quantile(selif(VE_2006, hogar_region_suroeste.*decil_50_suroeste), 0.5);
VE_2006_d_60_suroeste=quantile(selif(VE_2006, hogar_region_suroeste.*decil_60_suroeste), 0.5);
VE_2006_d_70_suroeste=quantile(selif(VE_2006, hogar_region_suroeste.*decil_70_suroeste), 0.5);
VE_2006_d_80_suroeste=quantile(selif(VE_2006, hogar_region_suroeste.*decil_80_suroeste), 0.5);
VE_2006_d_90_suroeste=quantile(selif(VE_2006, hogar_region_suroeste.*decil_90_suroeste), 0.5);
VE_2006_d_100_suroeste=quantile(selif(VE_2006, hogar_region_suroeste.*decil_100_suroeste), 0.5);

VE_2006_sureste=quantile(selif(VE_2006, hogar_region_sureste), 0.5);
VE_2006_d_10_sureste=quantile(selif(VE_2006, hogar_region_sureste.*decil_10_sureste), 0.5);
VE_2006_d_20_sureste=quantile(selif(VE_2006, hogar_region_sureste.*decil_20_sureste), 0.5);
VE_2006_d_30_sureste=quantile(selif(VE_2006, hogar_region_sureste.*decil_30_sureste), 0.5);
VE_2006_d_40_sureste=quantile(selif(VE_2006, hogar_region_sureste.*decil_40_sureste), 0.5);
VE_2006_d_50_sureste=quantile(selif(VE_2006, hogar_region_sureste.*decil_50_sureste), 0.5);
VE_2006_d_60_sureste=quantile(selif(VE_2006, hogar_region_sureste.*decil_60_sureste), 0.5);
VE_2006_d_70_sureste=quantile(selif(VE_2006, hogar_region_sureste.*decil_70_sureste), 0.5);
VE_2006_d_80_sureste=quantile(selif(VE_2006, hogar_region_sureste.*decil_80_sureste), 0.5);
VE_2006_d_90_sureste=quantile(selif(VE_2006, hogar_region_sureste.*decil_90_sureste), 0.5);
VE_2006_d_100_sureste=quantile(selif(VE_2006, hogar_region_sureste.*decil_100_sureste), 0.5);

VE_2006_este=quantile(selif(VE_2006, hogar_region_este), 0.5);
VE_2006_d_10_este=quantile(selif(VE_2006, hogar_region_este.*decil_10_este), 0.5);
VE_2006_d_20_este=quantile(selif(VE_2006, hogar_region_este.*decil_20_este), 0.5);
VE_2006_d_30_este=quantile(selif(VE_2006, hogar_region_este.*decil_30_este), 0.5);
VE_2006_d_40_este=quantile(selif(VE_2006, hogar_region_este.*decil_40_este), 0.5);
VE_2006_d_50_este=quantile(selif(VE_2006, hogar_region_este.*decil_50_este), 0.5);
VE_2006_d_60_este=quantile(selif(VE_2006, hogar_region_este.*decil_60_este), 0.5);
VE_2006_d_70_este=quantile(selif(VE_2006, hogar_region_este.*decil_70_este), 0.5);
VE_2006_d_80_este=quantile(selif(VE_2006, hogar_region_este.*decil_80_este), 0.5);
VE_2006_d_90_este=quantile(selif(VE_2006, hogar_region_este.*decil_90_este), 0.5);
VE_2006_d_100_este=quantile(selif(VE_2006, hogar_region_este.*decil_100_este), 0.5);

VE_2006_oeste=quantile(selif(VE_2006, hogar_region_oeste), 0.5);
VE_2006_d_10_oeste=quantile(selif(VE_2006, hogar_region_oeste.*decil_10_oeste), 0.5);
VE_2006_d_20_oeste=quantile(selif(VE_2006, hogar_region_oeste.*decil_20_oeste), 0.5);
VE_2006_d_30_oeste=quantile(selif(VE_2006, hogar_region_oeste.*decil_30_oeste), 0.5);
VE_2006_d_40_oeste=quantile(selif(VE_2006, hogar_region_oeste.*decil_40_oeste), 0.5);
VE_2006_d_50_oeste=quantile(selif(VE_2006, hogar_region_oeste.*decil_50_oeste), 0.5);
VE_2006_d_60_oeste=quantile(selif(VE_2006, hogar_region_oeste.*decil_60_oeste), 0.5);
VE_2006_d_70_oeste=quantile(selif(VE_2006, hogar_region_oeste.*decil_70_oeste), 0.5);
VE_2006_d_80_oeste=quantile(selif(VE_2006, hogar_region_oeste.*decil_80_oeste), 0.5);
VE_2006_d_90_oeste=quantile(selif(VE_2006, hogar_region_oeste.*decil_90_oeste), 0.5);
VE_2006_d_100_oeste=quantile(selif(VE_2006, hogar_region_oeste.*decil_100_oeste), 0.5);


VE_ingr_2006_noroeste=quantile(selif(VE_ingr_2006, hogar_region_noroeste), 0.5);
VE_ingr_2006_d_10_noroeste=quantile(selif(VE_ingr_2006, hogar_region_noroeste.*decil_10_noroeste), 0.5);
VE_ingr_2006_d_20_noroeste=quantile(selif(VE_ingr_2006, hogar_region_noroeste.*decil_20_noroeste), 0.5);
VE_ingr_2006_d_30_noroeste=quantile(selif(VE_ingr_2006, hogar_region_noroeste.*decil_30_noroeste), 0.5);
VE_ingr_2006_d_40_noroeste=quantile(selif(VE_ingr_2006, hogar_region_noroeste.*decil_40_noroeste), 0.5);
VE_ingr_2006_d_50_noroeste=quantile(selif(VE_ingr_2006, hogar_region_noroeste.*decil_50_noroeste), 0.5);
VE_ingr_2006_d_60_noroeste=quantile(selif(VE_ingr_2006, hogar_region_noroeste.*decil_60_noroeste), 0.5);
VE_ingr_2006_d_70_noroeste=quantile(selif(VE_ingr_2006, hogar_region_noroeste.*decil_70_noroeste), 0.5);
VE_ingr_2006_d_80_noroeste=quantile(selif(VE_ingr_2006, hogar_region_noroeste.*decil_80_noroeste), 0.5);
VE_ingr_2006_d_90_noroeste=quantile(selif(VE_ingr_2006, hogar_region_noroeste.*decil_90_noroeste), 0.5);
VE_ingr_2006_d_100_noroeste=quantile(selif(VE_ingr_2006, hogar_region_noroeste.*decil_100_noroeste), 0.5);

VE_ingr_2006_noreste=quantile(selif(VE_ingr_2006, hogar_region_noreste), 0.5);
VE_ingr_2006_d_10_noreste=quantile(selif(VE_ingr_2006, hogar_region_noreste.*decil_10_noreste), 0.5);
VE_ingr_2006_d_20_noreste=quantile(selif(VE_ingr_2006, hogar_region_noreste.*decil_20_noreste), 0.5);
VE_ingr_2006_d_30_noreste=quantile(selif(VE_ingr_2006, hogar_region_noreste.*decil_30_noreste), 0.5);
VE_ingr_2006_d_40_noreste=quantile(selif(VE_ingr_2006, hogar_region_noreste.*decil_40_noreste), 0.5);
VE_ingr_2006_d_50_noreste=quantile(selif(VE_ingr_2006, hogar_region_noreste.*decil_50_noreste), 0.5);
VE_ingr_2006_d_60_noreste=quantile(selif(VE_ingr_2006, hogar_region_noreste.*decil_60_noreste), 0.5);
VE_ingr_2006_d_70_noreste=quantile(selif(VE_ingr_2006, hogar_region_noreste.*decil_70_noreste), 0.5);
VE_ingr_2006_d_80_noreste=quantile(selif(VE_ingr_2006, hogar_region_noreste.*decil_80_noreste), 0.5);
VE_ingr_2006_d_90_noreste=quantile(selif(VE_ingr_2006, hogar_region_noreste.*decil_90_noreste), 0.5);
VE_ingr_2006_d_100_noreste=quantile(selif(VE_ingr_2006, hogar_region_noreste.*decil_100_noreste), 0.5);

VE_ingr_2006_centro_norte=quantile(selif(VE_ingr_2006, hogar_region_centro_norte), 0.5);
VE_ingr_2006_d_10_centro_norte=quantile(selif(VE_ingr_2006, hogar_region_centro_norte.*decil_10_centro_norte), 0.5);
VE_ingr_2006_d_20_centro_norte=quantile(selif(VE_ingr_2006, hogar_region_centro_norte.*decil_20_centro_norte), 0.5);
VE_ingr_2006_d_30_centro_norte=quantile(selif(VE_ingr_2006, hogar_region_centro_norte.*decil_30_centro_norte), 0.5);
VE_ingr_2006_d_40_centro_norte=quantile(selif(VE_ingr_2006, hogar_region_centro_norte.*decil_40_centro_norte), 0.5);
VE_ingr_2006_d_50_centro_norte=quantile(selif(VE_ingr_2006, hogar_region_centro_norte.*decil_50_centro_norte), 0.5);
VE_ingr_2006_d_60_centro_norte=quantile(selif(VE_ingr_2006, hogar_region_centro_norte.*decil_60_centro_norte), 0.5);
VE_ingr_2006_d_70_centro_norte=quantile(selif(VE_ingr_2006, hogar_region_centro_norte.*decil_70_centro_norte), 0.5);
VE_ingr_2006_d_80_centro_norte=quantile(selif(VE_ingr_2006, hogar_region_centro_norte.*decil_80_centro_norte), 0.5);
VE_ingr_2006_d_90_centro_norte=quantile(selif(VE_ingr_2006, hogar_region_centro_norte.*decil_90_centro_norte), 0.5);
VE_ingr_2006_d_100_centro_norte=quantile(selif(VE_ingr_2006, hogar_region_centro_norte.*decil_100_centro_norte), 0.5);


VE_ingr_2006_centro_sur=quantile(selif(VE_ingr_2006, hogar_region_centro_sur), 0.5);
VE_ingr_2006_d_10_centro_sur=quantile(selif(VE_ingr_2006, hogar_region_centro_sur.*decil_10_centro_sur), 0.5);
VE_ingr_2006_d_20_centro_sur=quantile(selif(VE_ingr_2006, hogar_region_centro_sur.*decil_20_centro_sur), 0.5);
VE_ingr_2006_d_30_centro_sur=quantile(selif(VE_ingr_2006, hogar_region_centro_sur.*decil_30_centro_sur), 0.5);
VE_ingr_2006_d_40_centro_sur=quantile(selif(VE_ingr_2006, hogar_region_centro_sur.*decil_40_centro_sur), 0.5);
VE_ingr_2006_d_50_centro_sur=quantile(selif(VE_ingr_2006, hogar_region_centro_sur.*decil_50_centro_sur), 0.5);
VE_ingr_2006_d_60_centro_sur=quantile(selif(VE_ingr_2006, hogar_region_centro_sur.*decil_60_centro_sur), 0.5);
VE_ingr_2006_d_70_centro_sur=quantile(selif(VE_ingr_2006, hogar_region_centro_sur.*decil_70_centro_sur), 0.5);
VE_ingr_2006_d_80_centro_sur=quantile(selif(VE_ingr_2006, hogar_region_centro_sur.*decil_80_centro_sur), 0.5);
VE_ingr_2006_d_90_centro_sur=quantile(selif(VE_ingr_2006, hogar_region_centro_sur.*decil_90_centro_sur), 0.5);
VE_ingr_2006_d_100_centro_sur=quantile(selif(VE_ingr_2006, hogar_region_centro_sur.*decil_100_centro_sur), 0.5);


VE_ingr_2006_suroeste=quantile(selif(VE_ingr_2006, hogar_region_suroeste), 0.5);
VE_ingr_2006_d_10_suroeste=quantile(selif(VE_ingr_2006, hogar_region_suroeste.*decil_10_suroeste), 0.5);

VE_ingr_2006_d_10_suroeste_bis=quantile(selif(VE_ingr_2006, hogar_region_suroeste.*decil_10_suroeste), 0.45);
VE_ingr_2006_d_10_suroeste_bis2=quantile(selif(VE_ingr_2006, hogar_region_suroeste.*decil_10_suroeste), 0.4);
VE_ingr_2006_d_10_suroeste_bis3=quantile(selif(VE_ingr_2006, hogar_region_suroeste.*decil_10_suroeste), 0.35);


VE_ingr_2006_d_20_suroeste=quantile(selif(VE_ingr_2006, hogar_region_suroeste.*decil_20_suroeste), 0.5);
VE_ingr_2006_d_30_suroeste=quantile(selif(VE_ingr_2006, hogar_region_suroeste.*decil_30_suroeste), 0.5);
VE_ingr_2006_d_40_suroeste=quantile(selif(VE_ingr_2006, hogar_region_suroeste.*decil_40_suroeste), 0.5);
VE_ingr_2006_d_50_suroeste=quantile(selif(VE_ingr_2006, hogar_region_suroeste.*decil_50_suroeste), 0.5);
VE_ingr_2006_d_60_suroeste=quantile(selif(VE_ingr_2006, hogar_region_suroeste.*decil_60_suroeste), 0.5);
VE_ingr_2006_d_70_suroeste=quantile(selif(VE_ingr_2006, hogar_region_suroeste.*decil_70_suroeste), 0.5);
VE_ingr_2006_d_80_suroeste=quantile(selif(VE_ingr_2006, hogar_region_suroeste.*decil_80_suroeste), 0.5);
VE_ingr_2006_d_90_suroeste=quantile(selif(VE_ingr_2006, hogar_region_suroeste.*decil_90_suroeste), 0.5);
VE_ingr_2006_d_100_suroeste=quantile(selif(VE_ingr_2006, hogar_region_suroeste.*decil_100_suroeste), 0.5);

VE_ingr_2006_sureste=quantile(selif(VE_ingr_2006, hogar_region_sureste), 0.5);
VE_ingr_2006_d_10_sureste=quantile(selif(VE_ingr_2006, hogar_region_sureste.*decil_10_sureste), 0.5);
VE_ingr_2006_d_20_sureste=quantile(selif(VE_ingr_2006, hogar_region_sureste.*decil_20_sureste), 0.5);
VE_ingr_2006_d_30_sureste=quantile(selif(VE_ingr_2006, hogar_region_sureste.*decil_30_sureste), 0.5);
VE_ingr_2006_d_40_sureste=quantile(selif(VE_ingr_2006, hogar_region_sureste.*decil_40_sureste), 0.5);
VE_ingr_2006_d_50_sureste=quantile(selif(VE_ingr_2006, hogar_region_sureste.*decil_50_sureste), 0.5);
VE_ingr_2006_d_60_sureste=quantile(selif(VE_ingr_2006, hogar_region_sureste.*decil_60_sureste), 0.5);
VE_ingr_2006_d_70_sureste=quantile(selif(VE_ingr_2006, hogar_region_sureste.*decil_70_sureste), 0.5);
VE_ingr_2006_d_80_sureste=quantile(selif(VE_ingr_2006, hogar_region_sureste.*decil_80_sureste), 0.5);
VE_ingr_2006_d_90_sureste=quantile(selif(VE_ingr_2006, hogar_region_sureste.*decil_90_sureste), 0.5);
VE_ingr_2006_d_100_sureste=quantile(selif(VE_ingr_2006, hogar_region_sureste.*decil_100_sureste), 0.5);

VE_ingr_2006_este=quantile(selif(VE_ingr_2006, hogar_region_este), 0.5);
VE_ingr_2006_d_10_este=quantile(selif(VE_ingr_2006, hogar_region_este.*decil_10_este), 0.5);
VE_ingr_2006_d_20_este=quantile(selif(VE_ingr_2006, hogar_region_este.*decil_20_este), 0.5);
VE_ingr_2006_d_30_este=quantile(selif(VE_ingr_2006, hogar_region_este.*decil_30_este), 0.5);
VE_ingr_2006_d_40_este=quantile(selif(VE_ingr_2006, hogar_region_este.*decil_40_este), 0.5);
VE_ingr_2006_d_50_este=quantile(selif(VE_ingr_2006, hogar_region_este.*decil_50_este), 0.5);
VE_ingr_2006_d_60_este=quantile(selif(VE_ingr_2006, hogar_region_este.*decil_60_este), 0.5);
VE_ingr_2006_d_70_este=quantile(selif(VE_ingr_2006, hogar_region_este.*decil_70_este), 0.5);
VE_ingr_2006_d_80_este=quantile(selif(VE_ingr_2006, hogar_region_este.*decil_80_este), 0.5);
VE_ingr_2006_d_90_este=quantile(selif(VE_ingr_2006, hogar_region_este.*decil_90_este), 0.5);
VE_ingr_2006_d_100_este=quantile(selif(VE_ingr_2006, hogar_region_este.*decil_100_este), 0.5);

VE_ingr_2006_oeste=quantile(selif(VE_ingr_2006, hogar_region_oeste), 0.5);
VE_ingr_2006_d_10_oeste=quantile(selif(VE_ingr_2006, hogar_region_oeste.*decil_10_oeste), 0.5);
VE_ingr_2006_d_20_oeste=quantile(selif(VE_ingr_2006, hogar_region_oeste.*decil_20_oeste), 0.5);
VE_ingr_2006_d_30_oeste=quantile(selif(VE_ingr_2006, hogar_region_oeste.*decil_30_oeste), 0.5);
VE_ingr_2006_d_40_oeste=quantile(selif(VE_ingr_2006, hogar_region_oeste.*decil_40_oeste), 0.5);
VE_ingr_2006_d_50_oeste=quantile(selif(VE_ingr_2006, hogar_region_oeste.*decil_50_oeste), 0.5);
VE_ingr_2006_d_60_oeste=quantile(selif(VE_ingr_2006, hogar_region_oeste.*decil_60_oeste), 0.5);
VE_ingr_2006_d_70_oeste=quantile(selif(VE_ingr_2006, hogar_region_oeste.*decil_70_oeste), 0.5);
VE_ingr_2006_d_80_oeste=quantile(selif(VE_ingr_2006, hogar_region_oeste.*decil_80_oeste), 0.5);
VE_ingr_2006_d_90_oeste=quantile(selif(VE_ingr_2006, hogar_region_oeste.*decil_90_oeste), 0.5);
VE_ingr_2006_d_100_oeste=quantile(selif(VE_ingr_2006, hogar_region_oeste.*decil_100_oeste), 0.5);


INPC_octubre_2006=80.723107583458;
INPC_octubre_2015=117.410;
factor_inflac_2006=INPC_octubre_2015/INPC_octubre_2006;
markups_empiricos_signific_2006=meanc(markups_cinco_mayores_bis);
markups_empiricos_todos_2006=meanc(markups_todos_bis);
elastic_demanda_agregada_2006=elastic_agregadas_vector;
t_stat_markups_2006=resumen_resultados[.,2];

elast_prom_noroeste_2006=meanc(selif(elastic_46_ciudades_matrix, ciudad_region_noroeste));
elast_prom_noreste_2006=meanc(selif(elastic_46_ciudades_matrix, ciudad_region_noreste));
elast_prom_centro_norte_2006=meanc(selif(elastic_46_ciudades_matrix, ciudad_region_centro_norte));
elast_prom_centro_sur_2006=meanc(selif(elastic_46_ciudades_matrix, ciudad_region_centro_sur));
elast_prom_suroeste_2006=meanc(selif(elastic_46_ciudades_matrix, ciudad_region_suroeste));
elast_prom_sureste_2006=meanc(selif(elastic_46_ciudades_matrix, ciudad_region_sureste));
elast_prom_oeste_2006=meanc(selif(elastic_46_ciudades_matrix, ciudad_region_oeste));
elast_prom_este_2006=meanc(selif(elastic_46_ciudades_matrix, ciudad_region_este));



elastic_regionales_2006=elast_prom_noroeste_2006~elast_prom_noreste_2006~elast_prom_centro_norte_2006~elast_prom_centro_sur_2006~elast_prom_suroeste_2006~elast_prom_sureste_2006
~elast_prom_oeste_2006~elast_prom_este_2006;

elast_prom_noroeste_2006_fin=meanc(selif(elastic_46_ciudades_matrix_bis, ciudad_region_noroeste));
elast_prom_noreste_2006_fin=meanc(selif(elastic_46_ciudades_matrix_bis, ciudad_region_noreste));
elast_prom_centro_norte_2006_fin=meanc(selif(elastic_46_ciudades_matrix_bis, ciudad_region_centro_norte));
elast_prom_centro_sur_2006_fin=meanc(selif(elastic_46_ciudades_matrix_bis, ciudad_region_centro_sur));
elast_prom_suroeste_2006_fin=meanc(selif(elastic_46_ciudades_matrix_bis, ciudad_region_suroeste));
elast_prom_sureste_2006_fin=meanc(selif(elastic_46_ciudades_matrix_bis, ciudad_region_sureste));
elast_prom_oeste_2006_fin=meanc(selif(elastic_46_ciudades_matrix_bis, ciudad_region_oeste));
elast_prom_este_2006_fin=meanc(selif(elastic_46_ciudades_matrix_bis, ciudad_region_este));


elastic_regionales_2006_fin=elast_prom_noroeste_2006_fin~elast_prom_noreste_2006_fin~elast_prom_centro_norte_2006_fin~elast_prom_centro_sur_2006_fin~elast_prom_suroeste_2006_fin~elast_prom_sureste_2006_fin
~elast_prom_oeste_2006_fin~elast_prom_este_2006_fin;

resultados_todo_pais_2006=
(VE_2006_todo_pais*factor_inflac_2006|
VE_2006_decil_10_todo_pais*factor_inflac_2006|
VE_2006_decil_20_todo_pais*factor_inflac_2006|
VE_2006_decil_30_todo_pais*factor_inflac_2006|
VE_2006_decil_40_todo_pais*factor_inflac_2006|
VE_2006_decil_50_todo_pais*factor_inflac_2006|
VE_2006_decil_60_todo_pais*factor_inflac_2006|
VE_2006_decil_70_todo_pais*factor_inflac_2006|
VE_2006_decil_80_todo_pais*factor_inflac_2006|
VE_2006_decil_90_todo_pais*factor_inflac_2006|
VE_2006_decil_100_todo_pais*factor_inflac_2006)~
(VE_ingr_2006_todo_pais|
VE_ingr_2006_d_10_todo_pais|
VE_ingr_2006_d_20_todo_pais|
VE_ingr_2006_d_30_todo_pais|
VE_ingr_2006_d_40_todo_pais|
VE_ingr_2006_d_50_todo_pais|
VE_ingr_2006_d_60_todo_pais|
VE_ingr_2006_d_70_todo_pais|
VE_ingr_2006_d_80_todo_pais|
VE_ingr_2006_d_90_todo_pais|
VE_ingr_2006_d_100_todo_pais);

resultados_noroeste_2006=
(VE_2006_noroeste*factor_inflac_2006|
VE_2006_d_10_noroeste*factor_inflac_2006|
VE_2006_d_20_noroeste*factor_inflac_2006|
VE_2006_d_30_noroeste*factor_inflac_2006|
VE_2006_d_40_noroeste*factor_inflac_2006|
VE_2006_d_50_noroeste*factor_inflac_2006|
VE_2006_d_60_noroeste*factor_inflac_2006|
VE_2006_d_70_noroeste*factor_inflac_2006|
VE_2006_d_80_noroeste*factor_inflac_2006|
VE_2006_d_90_noroeste*factor_inflac_2006|
VE_2006_d_100_noroeste*factor_inflac_2006)~
(VE_ingr_2006_noroeste|
VE_ingr_2006_d_10_noroeste|
VE_ingr_2006_d_20_noroeste|
VE_ingr_2006_d_30_noroeste|
VE_ingr_2006_d_40_noroeste|
VE_ingr_2006_d_50_noroeste|
VE_ingr_2006_d_60_noroeste|
VE_ingr_2006_d_70_noroeste|
VE_ingr_2006_d_80_noroeste|
VE_ingr_2006_d_90_noroeste|
VE_ingr_2006_d_100_noroeste);


resultados_noreste_2006=
(VE_2006_noreste*factor_inflac_2006|
VE_2006_d_10_noreste*factor_inflac_2006|
VE_2006_d_20_noreste*factor_inflac_2006|
VE_2006_d_30_noreste*factor_inflac_2006|
VE_2006_d_40_noreste*factor_inflac_2006|
VE_2006_d_50_noreste*factor_inflac_2006|
VE_2006_d_60_noreste*factor_inflac_2006|
VE_2006_d_70_noreste*factor_inflac_2006|
VE_2006_d_80_noreste*factor_inflac_2006|
VE_2006_d_90_noreste*factor_inflac_2006|
VE_2006_d_100_noreste*factor_inflac_2006)~
(VE_ingr_2006_noreste|
VE_ingr_2006_d_10_noreste|
VE_ingr_2006_d_20_noreste|
VE_ingr_2006_d_30_noreste|
VE_ingr_2006_d_40_noreste|
VE_ingr_2006_d_50_noreste|
VE_ingr_2006_d_60_noreste|
VE_ingr_2006_d_70_noreste|
VE_ingr_2006_d_80_noreste|
VE_ingr_2006_d_90_noreste|
VE_ingr_2006_d_100_noreste);


resultados_centro_norte_2006=
(VE_2006_centro_norte*factor_inflac_2006|
VE_2006_d_10_centro_norte*factor_inflac_2006|
VE_2006_d_20_centro_norte*factor_inflac_2006|
VE_2006_d_30_centro_norte*factor_inflac_2006|
VE_2006_d_40_centro_norte*factor_inflac_2006|
VE_2006_d_50_centro_norte*factor_inflac_2006|
VE_2006_d_60_centro_norte*factor_inflac_2006|
VE_2006_d_70_centro_norte*factor_inflac_2006|
VE_2006_d_80_centro_norte*factor_inflac_2006|
VE_2006_d_90_centro_norte*factor_inflac_2006|
VE_2006_d_100_centro_norte*factor_inflac_2006)~
(VE_ingr_2006_centro_norte|
VE_ingr_2006_d_10_centro_norte|
VE_ingr_2006_d_20_centro_norte|
VE_ingr_2006_d_30_centro_norte|
VE_ingr_2006_d_40_centro_norte|
VE_ingr_2006_d_50_centro_norte|
VE_ingr_2006_d_60_centro_norte|
VE_ingr_2006_d_70_centro_norte|
VE_ingr_2006_d_80_centro_norte|
VE_ingr_2006_d_90_centro_norte|
VE_ingr_2006_d_100_centro_norte);


resultados_centro_sur_2006=
(VE_2006_centro_sur*factor_inflac_2006|
VE_2006_d_10_centro_sur*factor_inflac_2006|
VE_2006_d_20_centro_sur*factor_inflac_2006|
VE_2006_d_30_centro_sur*factor_inflac_2006|
VE_2006_d_40_centro_sur*factor_inflac_2006|
VE_2006_d_50_centro_sur*factor_inflac_2006|
VE_2006_d_60_centro_sur*factor_inflac_2006|
VE_2006_d_70_centro_sur*factor_inflac_2006|
VE_2006_d_80_centro_sur*factor_inflac_2006|
VE_2006_d_90_centro_sur*factor_inflac_2006|
VE_2006_d_100_centro_sur*factor_inflac_2006)~
(VE_ingr_2006_centro_sur|
VE_ingr_2006_d_10_centro_sur|
VE_ingr_2006_d_20_centro_sur|
VE_ingr_2006_d_30_centro_sur|
VE_ingr_2006_d_40_centro_sur|
VE_ingr_2006_d_50_centro_sur|
VE_ingr_2006_d_60_centro_sur|
VE_ingr_2006_d_70_centro_sur|
VE_ingr_2006_d_80_centro_sur|
VE_ingr_2006_d_90_centro_sur|
VE_ingr_2006_d_100_centro_sur);

resultados_suroeste_2006=
(VE_2006_suroeste*factor_inflac_2006|
VE_2006_d_10_suroeste*factor_inflac_2006|
VE_2006_d_20_suroeste*factor_inflac_2006|
VE_2006_d_30_suroeste*factor_inflac_2006|
VE_2006_d_40_suroeste*factor_inflac_2006|
VE_2006_d_50_suroeste*factor_inflac_2006|
VE_2006_d_60_suroeste*factor_inflac_2006|
VE_2006_d_70_suroeste*factor_inflac_2006|
VE_2006_d_80_suroeste*factor_inflac_2006|
VE_2006_d_90_suroeste*factor_inflac_2006|
VE_2006_d_100_suroeste*factor_inflac_2006)~
(VE_ingr_2006_suroeste|
VE_ingr_2006_d_10_suroeste|
VE_ingr_2006_d_20_suroeste|
VE_ingr_2006_d_30_suroeste|
VE_ingr_2006_d_40_suroeste|
VE_ingr_2006_d_50_suroeste|
VE_ingr_2006_d_60_suroeste|
VE_ingr_2006_d_70_suroeste|
VE_ingr_2006_d_80_suroeste|
VE_ingr_2006_d_90_suroeste|
VE_ingr_2006_d_100_suroeste);

resultados_sureste_2006=
(VE_2006_sureste*factor_inflac_2006|
VE_2006_d_10_sureste*factor_inflac_2006|
VE_2006_d_20_sureste*factor_inflac_2006|
VE_2006_d_30_sureste*factor_inflac_2006|
VE_2006_d_40_sureste*factor_inflac_2006|
VE_2006_d_50_sureste*factor_inflac_2006|
VE_2006_d_60_sureste*factor_inflac_2006|
VE_2006_d_70_sureste*factor_inflac_2006|
VE_2006_d_80_sureste*factor_inflac_2006|
VE_2006_d_90_sureste*factor_inflac_2006|
VE_2006_d_100_sureste*factor_inflac_2006)~
(VE_ingr_2006_sureste|
VE_ingr_2006_d_10_sureste|
VE_ingr_2006_d_20_sureste|
VE_ingr_2006_d_30_sureste|
VE_ingr_2006_d_40_sureste|
VE_ingr_2006_d_50_sureste|
VE_ingr_2006_d_60_sureste|
VE_ingr_2006_d_70_sureste|
VE_ingr_2006_d_80_sureste|
VE_ingr_2006_d_90_sureste|
VE_ingr_2006_d_100_sureste);

resultados_oeste_2006=
(VE_2006_oeste*factor_inflac_2006|
VE_2006_d_10_oeste*factor_inflac_2006|
VE_2006_d_20_oeste*factor_inflac_2006|
VE_2006_d_30_oeste*factor_inflac_2006|
VE_2006_d_40_oeste*factor_inflac_2006|
VE_2006_d_50_oeste*factor_inflac_2006|
VE_2006_d_60_oeste*factor_inflac_2006|
VE_2006_d_70_oeste*factor_inflac_2006|
VE_2006_d_80_oeste*factor_inflac_2006|
VE_2006_d_90_oeste*factor_inflac_2006|
VE_2006_d_100_oeste*factor_inflac_2006)~
(VE_ingr_2006_oeste|
VE_ingr_2006_d_10_oeste|
VE_ingr_2006_d_20_oeste|
VE_ingr_2006_d_30_oeste|
VE_ingr_2006_d_40_oeste|
VE_ingr_2006_d_50_oeste|
VE_ingr_2006_d_60_oeste|
VE_ingr_2006_d_70_oeste|
VE_ingr_2006_d_80_oeste|
VE_ingr_2006_d_90_oeste|
VE_ingr_2006_d_100_oeste);


resultados_este_2006=
(VE_2006_este*factor_inflac_2006|
VE_2006_d_10_este*factor_inflac_2006|
VE_2006_d_20_este*factor_inflac_2006|
VE_2006_d_30_este*factor_inflac_2006|
VE_2006_d_40_este*factor_inflac_2006|
VE_2006_d_50_este*factor_inflac_2006|
VE_2006_d_60_este*factor_inflac_2006|
VE_2006_d_70_este*factor_inflac_2006|
VE_2006_d_80_este*factor_inflac_2006|
VE_2006_d_90_este*factor_inflac_2006|
VE_2006_d_100_este*factor_inflac_2006)~
(VE_ingr_2006_este|
VE_ingr_2006_d_10_este|
VE_ingr_2006_d_20_este|
VE_ingr_2006_d_30_este|
VE_ingr_2006_d_40_este|
VE_ingr_2006_d_50_este|
VE_ingr_2006_d_60_este|
VE_ingr_2006_d_70_este|
VE_ingr_2006_d_80_este|
VE_ingr_2006_d_90_este|
VE_ingr_2006_d_100_este);

VE_2006_debajo_decil_50=VE_2006_debajo_decil_50*factor_inflac_2006;
VE_ingr_2006_debajo_decil_50=VE_ingr_2006_debajo_decil_50;

VE_2006_bajo_d_50_noroeste=quantile(selif(VE_2006, hogar_region_noroeste.*debajo_decil_50_noroeste), 0.5);
VE_2006_bajo_d_50_noreste=quantile(selif(VE_2006, hogar_region_noreste.*debajo_decil_50_noroeste), 0.5);
VE_2006_bajo_d_50_centro_norte=quantile(selif(VE_2006, hogar_region_centro_norte.*debajo_decil_50_noroeste), 0.5);
VE_2006_bajo_d_50_centro_sur=quantile(selif(VE_2006, hogar_region_centro_sur.*debajo_decil_50_noroeste), 0.5);
VE_2006_bajo_d_50_suroeste=quantile(selif(VE_2006, hogar_region_suroeste.*debajo_decil_50_suroeste), 0.5);
VE_2006_bajo_d_50_sureste=quantile(selif(VE_2006, hogar_region_sureste.*debajo_decil_50_sureste), 0.5);
VE_2006_bajo_d_50_oeste=quantile(selif(VE_2006, hogar_region_oeste.*debajo_decil_50_oeste), 0.5);
VE_2006_bajo_d_50_este=quantile(selif(VE_2006, hogar_region_este.*debajo_decil_50_este), 0.5);



VE_2006_bajo_d_50_noroeste=VE_2006_bajo_d_50_noroeste*factor_inflac_2006;
VE_2006_bajo_d_50_noreste=VE_2006_bajo_d_50_noreste*factor_inflac_2006;
VE_2006_bajo_d_50_centro_norte=VE_2006_bajo_d_50_centro_norte*factor_inflac_2006;
VE_2006_bajo_d_50_centro_sur=VE_2006_bajo_d_50_centro_sur*factor_inflac_2006;
VE_2006_bajo_d_50_suroeste=VE_2006_bajo_d_50_suroeste*factor_inflac_2006;
VE_2006_bajo_d_50_sureste=VE_2006_bajo_d_50_sureste*factor_inflac_2006;
VE_2006_bajo_d_50_oeste=VE_2006_bajo_d_50_oeste*factor_inflac_2006;
VE_2006_bajo_d_50_este=VE_2006_bajo_d_50_este*factor_inflac_2006;


VE_ingr_06_baj_d_50_noroeste=quantile(selif(VE_ingr_2006, hogar_region_noroeste.*debajo_decil_50_noroeste), 0.5);
VE_ingr_06_baj_d_50_noreste=quantile(selif(VE_ingr_2006, hogar_region_noreste.*debajo_decil_50_noroeste), 0.5);
VE_ingr_06_baj_d_50_centro_norte=quantile(selif(VE_ingr_2006, hogar_region_centro_norte.*debajo_decil_50_noroeste), 0.5);
VE_ingr_06_baj_d_50_centro_sur=quantile(selif(VE_ingr_2006, hogar_region_centro_sur.*debajo_decil_50_noroeste), 0.5);
VE_ingr_06_baj_d_50_suroeste=quantile(selif(VE_ingr_2006, hogar_region_suroeste.*debajo_decil_50_suroeste), 0.5);
VE_ingr_06_baj_d_50_sureste=quantile(selif(VE_ingr_2006, hogar_region_sureste.*debajo_decil_50_sureste), 0.5);
VE_ingr_06_baj_d_50_oeste=quantile(selif(VE_ingr_2006, hogar_region_oeste.*debajo_decil_50_oeste), 0.5);
VE_ingr_06_baj_d_50_este=quantile(selif(VE_ingr_2006, hogar_region_este.*debajo_decil_50_este), 0.5);


nnn=rows(ingreso_2006_GINI);
aux_gini_vector=seqa(1,1,nnn);
Gini_coef_2006_todo_pais=(nnn+1)/nnn-(2/nnn)*(sumc(ingreso_2006_GINI.*((nnn+1-aux_gini_vector)))/sumc(ingreso_2006_GINI)); 

noncompetitive_taxes_2006=resultados_todo_pais_2006[2:11,2];
...
taxes_por_decil=aux_deciles.*(noncompetitive_taxes_2006');
taxes_por_decil=sumc(taxes_por_decil');

ingreso_2006_GINI_competitive=ingreso_2006_GINI.*(1/(1-taxes_por_decil));
ingreso_2006_GINI_competitive=sortc(ingreso_2006_GINI_competitive,1);
counterf_2006_GINI_todo_pais=(nnn+1)/nnn-(2/nnn)*(sumc(ingreso_2006_GINI_competitive.*((nnn+1-aux_gini_vector)))/sumc(ingreso_2006_GINI_competitive)); 

GINI_prop_diff_2006_todo_pais=(Gini_coef_2006_todo_pais-counterf_2006_GINI_todo_pais)/counterf_2006_GINI_todo_pais;

nnn_noroeste=rows(ingreso_2006_GINI_noroeste);
aux_gini_noroeste=seqa(1,1,nnn_noroeste);
Gini_coef_2006_noroeste=(nnn_noroeste+1)/nnn_noroeste-(2/nnn_noroeste)*(sumc(ingreso_2006_GINI_noroeste.*((nnn_noroeste+1-aux_gini_noroeste)))/sumc(ingreso_2006_GINI_noroeste)); 

noncompetitive_taxes_2006=resultados_noroeste_2006[2:11,2];
...
ingreso_2006_GINI_competitive=ingreso_2006_GINI_noroeste.*(1/(1-taxes_por_decil));
ingreso_2006_GINI_competitive=sortc(ingreso_2006_GINI_competitive,1);
counterf_2006_GINI_noroeste=(nnn_noroeste+1)/nnn_noroeste-(2/nnn_noroeste)*(sumc(ingreso_2006_GINI_competitive.*((nnn_noroeste+1-aux_gini_noroeste)))/sumc(ingreso_2006_GINI_competitive)); 

GINI_prop_diff_2006_noroeste=(Gini_coef_2006_noroeste-counterf_2006_GINI_noroeste)/counterf_2006_GINI_noroeste;


nnn_noreste=rows(ingreso_2006_GINI_noreste);
aux_gini_noreste=seqa(1,1,nnn_noreste);
Gini_coef_2006_noreste=(nnn_noreste+1)/nnn_noreste-(2/nnn_noreste)*(sumc(ingreso_2006_GINI_noreste.*((nnn_noreste+1-aux_gini_noreste)))/sumc(ingreso_2006_GINI_noreste)); 

noncompetitive_taxes_2006=resultados_noreste_2006[2:11,2];
...
ingreso_2006_GINI_competitive=ingreso_2006_GINI_noreste.*(1/(1-taxes_por_decil));
ingreso_2006_GINI_competitive=sortc(ingreso_2006_GINI_competitive,1);
counterf_2006_GINI_noreste=(nnn_noreste+1)/nnn_noreste-(2/nnn_noreste)*(sumc(ingreso_2006_GINI_competitive.*((nnn_noreste+1-aux_gini_noreste)))/sumc(ingreso_2006_GINI_competitive)); 

GINI_prop_diff_2006_noreste=(Gini_coef_2006_noreste-counterf_2006_GINI_noreste)/counterf_2006_GINI_noreste;


nnn_centro_norte=rows(ingreso_2006_GINI_centro_norte);
aux_gini_centro_norte=seqa(1,1,nnn_centro_norte);
Gini_coef_2006_centro_norte=(nnn_centro_norte+1)/nnn_centro_norte-(2/nnn_centro_norte)*(sumc(ingreso_2006_GINI_centro_norte.*((nnn_centro_norte+1-aux_gini_centro_norte)))/sumc(ingreso_2006_GINI_centro_norte)); 

noncompetitive_taxes_2006=resultados_centro_norte_2006[2:11,2];
...
ingreso_2006_GINI_competitive=ingreso_2006_GINI_centro_norte.*(1/(1-taxes_por_decil));
ingreso_2006_GINI_competitive=sortc(ingreso_2006_GINI_competitive,1);
counterf_2006_GINI_centro_norte=(nnn_centro_norte+1)/nnn_centro_norte-(2/nnn_centro_norte)*(sumc(ingreso_2006_GINI_competitive.*((nnn_centro_norte+1-aux_gini_centro_norte)))/sumc(ingreso_2006_GINI_competitive)); 

GINI_prop_diff_2006_centro_norte=(Gini_coef_2006_centro_norte-counterf_2006_GINI_centro_norte)/counterf_2006_GINI_centro_norte;


nnn_centro_sur=rows(ingreso_2006_GINI_centro_sur);
aux_gini_centro_sur=seqa(1,1,nnn_centro_sur);
Gini_coef_2006_centro_sur=(nnn_centro_sur+1)/nnn_centro_sur-(2/nnn_centro_sur)*(sumc(ingreso_2006_GINI_centro_sur.*((nnn_centro_sur+1-aux_gini_centro_sur)))/sumc(ingreso_2006_GINI_centro_sur)); 

noncompetitive_taxes_2006=resultados_centro_sur_2006[2:11,2];
...
ingreso_2006_GINI_competitive=ingreso_2006_GINI_centro_sur.*(1/(1-taxes_por_decil));
ingreso_2006_GINI_competitive=sortc(ingreso_2006_GINI_competitive,1);
counterf_2006_GINI_centro_sur=(nnn_centro_sur+1)/nnn_centro_sur-(2/nnn_centro_sur)*(sumc(ingreso_2006_GINI_competitive.*((nnn_centro_sur+1-aux_gini_centro_sur)))/sumc(ingreso_2006_GINI_competitive)); 

GINI_prop_diff_2006_centro_sur=(Gini_coef_2006_centro_sur-counterf_2006_GINI_centro_sur)/counterf_2006_GINI_centro_sur;


nnn_suroeste=rows(ingreso_2006_GINI_suroeste);
aux_gini_suroeste=seqa(1,1,nnn_suroeste);
Gini_coef_2006_suroeste=(nnn_suroeste+1)/nnn_suroeste-(2/nnn_suroeste)*(sumc(ingreso_2006_GINI_suroeste.*((nnn_suroeste+1-aux_gini_suroeste)))/sumc(ingreso_2006_GINI_suroeste)); 

noncompetitive_taxes_2006=resultados_suroeste_2006[2:11,2];
...
ingreso_2006_GINI_competitive=ingreso_2006_GINI_suroeste.*(1/(1-taxes_por_decil));
ingreso_2006_GINI_competitive=sortc(ingreso_2006_GINI_competitive,1);
counterf_2006_GINI_suroeste=(nnn_suroeste+1)/nnn_suroeste-(2/nnn_suroeste)*(sumc(ingreso_2006_GINI_competitive.*((nnn_suroeste+1-aux_gini_suroeste)))/sumc(ingreso_2006_GINI_competitive)); 

GINI_prop_diff_2006_suroeste=(Gini_coef_2006_suroeste-counterf_2006_GINI_suroeste)/counterf_2006_GINI_suroeste;


nnn_sureste=rows(ingreso_2006_GINI_sureste);
aux_gini_sureste=seqa(1,1,nnn_sureste);
Gini_coef_2006_sureste=(nnn_sureste+1)/nnn_sureste-(2/nnn_sureste)*(sumc(ingreso_2006_GINI_sureste.*((nnn_sureste+1-aux_gini_sureste)))/sumc(ingreso_2006_GINI_sureste)); 

noncompetitive_taxes_2006=resultados_sureste_2006[2:11,2];
...
ingreso_2006_GINI_competitive=ingreso_2006_GINI_sureste.*(1/(1-taxes_por_decil));
ingreso_2006_GINI_competitive=sortc(ingreso_2006_GINI_competitive,1);
counterf_2006_GINI_sureste=(nnn_sureste+1)/nnn_sureste-(2/nnn_sureste)*(sumc(ingreso_2006_GINI_competitive.*((nnn_sureste+1-aux_gini_sureste)))/sumc(ingreso_2006_GINI_competitive)); 

GINI_prop_diff_2006_sureste=(Gini_coef_2006_sureste-counterf_2006_GINI_sureste)/counterf_2006_GINI_sureste;


nnn_oeste=rows(ingreso_2006_GINI_oeste);
aux_gini_oeste=seqa(1,1,nnn_oeste);
Gini_coef_2006_oeste=(nnn_oeste+1)/nnn_oeste-(2/nnn_oeste)*(sumc(ingreso_2006_GINI_oeste.*((nnn_oeste+1-aux_gini_oeste)))/sumc(ingreso_2006_GINI_oeste)); 

noncompetitive_taxes_2006=resultados_oeste_2006[2:11,2];
...
ingreso_2006_GINI_competitive=ingreso_2006_GINI_oeste.*(1/(1-taxes_por_decil));
ingreso_2006_GINI_competitive=sortc(ingreso_2006_GINI_competitive,1);
counterf_2006_GINI_oeste=(nnn_oeste+1)/nnn_oeste-(2/nnn_oeste)*(sumc(ingreso_2006_GINI_competitive.*((nnn_oeste+1-aux_gini_oeste)))/sumc(ingreso_2006_GINI_competitive)); 

GINI_prop_diff_2006_oeste=(Gini_coef_2006_oeste-counterf_2006_GINI_oeste)/counterf_2006_GINI_oeste;

nnn_este=rows(ingreso_2006_GINI_este);
aux_gini_este=seqa(1,1,nnn_este);
Gini_coef_2006_este=(nnn_este+1)/nnn_este-(2/nnn_este)*(sumc(ingreso_2006_GINI_este.*((nnn_este+1-aux_gini_este)))/sumc(ingreso_2006_GINI_este)); 

noncompetitive_taxes_2006=resultados_este_2006[2:11,2];
...
ingreso_2006_GINI_competitive=ingreso_2006_GINI_este.*(1/(1-taxes_por_decil));
ingreso_2006_GINI_competitive=sortc(ingreso_2006_GINI_competitive,1);
counterf_2006_GINI_este=(nnn_este+1)/nnn_este-(2/nnn_este)*(sumc(ingreso_2006_GINI_competitive.*((nnn_este+1-aux_gini_este)))/sumc(ingreso_2006_GINI_competitive)); 

GINI_prop_diff_2006_este=(Gini_coef_2006_este-counterf_2006_GINI_este)/counterf_2006_GINI_este;


GINI_coefficients_2006=
Gini_coef_2006_todo_pais|
Gini_coef_2006_noroeste|
Gini_coef_2006_noreste|
Gini_coef_2006_centro_norte|
Gini_coef_2006_centro_sur|
Gini_coef_2006_suroeste|
Gini_coef_2006_sureste|
Gini_coef_2006_oeste|
Gini_coef_2006_este;


counterf_GINI_coefficients_2006=
counterf_2006_GINI_todo_pais|
counterf_2006_GINI_noroeste|
counterf_2006_GINI_noreste|
counterf_2006_GINI_centro_norte|
counterf_2006_GINI_centro_sur|
counterf_2006_GINI_suroeste|
counterf_2006_GINI_sureste|
counterf_2006_GINI_oeste|
counterf_2006_GINI_este;

unidades_econom_por_hogar_2006=zeros(num_hogares,1);
unidades_econom_total_2006=zeros(num_hogares,1);
empleados_por_unidad_econom_2006=zeros(num_hogares,1);
activos_por_unidad_econom_2006=zeros(num_hogares,1);
valor_agregado_por_empleado_2006=zeros(num_hogares,1);
valor_agregado_por_activos_2006=zeros(num_hogares,1);
valor_agregado_por_unidad_2006=zeros(num_hogares,1);
UE_por_hogar_CENSO_2010_2006=zeros(num_hogares,1);
...
noroeste_indicadora_2006=maxc((ciudad_46_mas_cercana .eq noroeste')');
noreste_indicadora_2006=maxc((ciudad_46_mas_cercana .eq noreste')');
centro_norte_indicadora_2006=maxc((ciudad_46_mas_cercana .eq centro_norte')');
centro_sur_indicadora_2006=maxc((ciudad_46_mas_cercana .eq centro_sur')');
suroeste_indicadora_2006=maxc((ciudad_46_mas_cercana .eq suroeste')');
sureste_indicadora_2006=maxc((ciudad_46_mas_cercana .eq sureste')');
oeste_indicadora_2006=maxc((ciudad_46_mas_cercana .eq oeste')');
este_indicadora_2006=maxc((ciudad_46_mas_cercana .eq este')');
...
unidades_econom_por_hogar_2006[i]=numero_unidades_economicas/poblacion_ciudad_del_hogar;
pob_ciudad_del_hogar_CENSO_2010=poblacion_total_46_ciudades[ciudad_del_hogar];
unidades_econom_total_2006[i]=numero_unidades_economicas;
UE_por_hogar_CENSO_2010_2006[i]=numero_unidades_economicas/pob_ciudad_del_hogar_CENSO_2010;	/*Numero de unidades economicas por cada MIL habitantes*/
empleados_por_unidad_econom_2006[i]=empleados_por_UE[ciudad_del_hogar];	
activos_por_unidad_econom_2006[i]=activos_fijos_por_UE[ciudad_del_hogar];
valor_agregado_por_empleado_2006[i]=valor_agregado_por_empleado[ciudad_del_hogar];
valor_agregado_por_activos_2006[i]=valor_agregado_por_activos[ciudad_del_hogar];
valor_agregado_por_unidad_2006[i]=valor_agregado_por_unidad[ciudad_del_hogar];
i=i+1;
endo;    

aux_ciudades=seqa(1,1,46);
VE_ciudad_2006=zeros(46,1);
VE_ingr_ciudad_2006=zeros(46,1);
numero_establecimientos_2006=zeros(46,1);
tamano_ciudad_2006=zeros(46,1);
mm=1;
do while mm .le 46;
numero_establecimientos_2006[mm]=unidades_economicas[mm];    
VE_ingr_ciudad_2006[mm]=quantile((selif(VE_ingr_2006, ciudad_46_mas_cercana .eq mm)),0.5);
VE_ciudad_2006[mm]=quantile((selif(VE_2006, ciudad_46_mas_cercana .eq mm)),0.5);
tamano_ciudad_2006[mm]=poblacion_hogares_46_ciudades[mm,2];
mm=mm+1;
endo;    
   
VE_ciudad_2006=VE_ciudad_2006*factor_inflac_2006;
X1_2006=unidades_econom_por_hogar_2006;
X2_2006=empleados_por_unidad_econom_2006;
X3_2006=activos_por_unidad_econom_2006;
X4_2006=valor_agregado_por_empleado_2006;
X5_2006=valor_agregado_por_activos_2006;
X6_2006=valor_agregado_por_unidad_2006;
X7_2006=UE_por_hogar_CENSO_2010_2006;


Vars_1_2006=selif(VE_ingr_2006~X1_2006, (VE_ingr_2006 .le quantile(VE_ingr_2006, 0.90)).*(X1_2006 .le quantile(X1_2006,0.90)));
Y1_2006=Vars_1_2006[.,1];
X1_2006=Vars_1_2006[.,2];

jij=1;
do while jij .le 500;
if jij .eq 1;
X1_values_2006=quantile(X1_2006,0.01);
else;
X1_values_2006=X1_values_2006|X1_values_2006[jij-1]+(quantile(X1_2006,0.90)-quantile(X1_2006,0.01))/499;
endif;
if maxc(X1_values_2006 .le quantile(X1_2006,0.90));
jij=jij+1;
else;
jij=501;
endif;
...
N1=rows(Y1_2006);
N1_vals=rows(X1_values_2006);

sigma_x1=stdc(X1_2006);
C_h=4;
alpha_h=1/5;
bandwidth_1=C_h*sigma_x1*N1^(-alpha_h);

E_Y_X1_2006=zeros(N1_vals,1);

i=1;
do while i .le N1_vals;
X1_val=X1_values_2006[i];
psi=(X1_2006-X1_val)/bandwidth_1;
kernel_vector=pdfn(psi);
E_Y_X1_2006[i]=meanc(Y1_2006.*kernel_vector)/meanc(kernel_vector);	
i=i+1;
endo;


Vars_2_2006=selif(VE_ingr_2006~X2_2006, (VE_ingr_2006 .le quantile(VE_ingr_2006, 0.90)).*(X2_2006 .le quantile(X2_2006,0.90)));
Y2_2006=Vars_2_2006[.,1];
X2_2006=Vars_2_2006[.,2];

jij=1;
do while jij .le 500;
if jij .eq 1;
X2_values_2006=quantile(X2_2006,0.01);
else;
X2_values_2006=X2_values_2006|X2_values_2006[jij-1]+(30-quantile(X2_2006,0.01))/499;
endif;
if maxc(X2_values_2006 .le 30);
jij=jij+1;
else;
jij=501;
endif;
...
N2=rows(Y2_2006);
N2_vals=rows(X2_values_2006);

sigma_X2=stdc(X2_2006);
C_h=4;
alpha_h=1/5;
bandwidth_1=C_h*sigma_X2*N2^(-alpha_h);

E_Y_X2_2006=zeros(N2_vals,1);

i=1;
do while i .le N2_vals;
X2_val=X2_values_2006[i];
psi=(X2_2006-X2_val)/bandwidth_1;
kernel_vector=pdfn(psi);
E_Y_X2_2006[i]=meanc(Y2_2006.*kernel_vector)/meanc(kernel_vector);	
i=i+1;
endo;


Vars_3_2006=selif(VE_ingr_2006~X3_2006, (VE_ingr_2006 .le quantile(VE_ingr_2006, 0.90)).*(X3_2006 .le quantile(X3_2006,0.90)));
Y3_2006=Vars_3_2006[.,1];
X3_2006=Vars_3_2006[.,2];

jij=1;
do while jij .le 500;
if jij .eq 1;
X3_values_2006=quantile(X3_2006,0.01);
else;
X3_values_2006=X3_values_2006|X3_values_2006[jij-1]+(quantile(X3_2006,0.90)-quantile(X3_2006,0.01))/499;
endif;
if maxc(X3_values_2006 .le quantile(X3_2006,0.90));
jij=jij+1;
else;
jij=501;
endif;
...
N3=rows(Y3_2006);
N3_vals=rows(X3_values_2006);

sigma_X3=stdc(X3_2006);
C_h=4;
alpha_h=1/5;
bandwidth_1=C_h*sigma_X3*N3^(-alpha_h);

E_Y_X3_2006=zeros(N3_vals,1);

i=1;
do while i .le N3_vals;
X3_val=X3_values_2006[i];
psi=(X3_2006-X3_val)/bandwidth_1;
kernel_vector=pdfn(psi);
E_Y_X3_2006[i]=meanc(Y3_2006.*kernel_vector)/meanc(kernel_vector);	
i=i+1;
endo;


Vars_4_2006=selif(VE_ingr_2006~X4_2006, (VE_ingr_2006 .le quantile(VE_ingr_2006, 0.90)).*(X4_2006 .le quantile(X4_2006,0.90)));
Y4_2006=Vars_4_2006[.,1];
X4_2006=Vars_4_2006[.,2];

jij=1;
do while jij .le 500;
if jij .eq 1;
X4_values_2006=quantile(X4_2006,0.01);
else;
X4_values_2006=X4_values_2006|X4_values_2006[jij-1]+(quantile(X4_2006,0.90)-quantile(X4_2006,0.01))/499;
endif;
if maxc(X4_values_2006 .le quantile(X4_2006,0.90));
jij=jij+1;
else;
jij=501;
endif;
...
N4=rows(Y4_2006);
N4_vals=rows(X4_values_2006);

sigma_X4=stdc(X4_2006);
C_h=4;
alpha_h=1/5;
bandwidth_1=C_h*sigma_X4*N4^(-alpha_h);

E_Y_X4_2006=zeros(N4_vals,1);

i=1;
do while i .le N4_vals;
X4_val=X4_values_2006[i];
psi=(X4_2006-X4_val)/bandwidth_1;
kernel_vector=pdfn(psi);
E_Y_X4_2006[i]=meanc(Y4_2006.*kernel_vector)/meanc(kernel_vector);	
i=i+1;
endo;

Vars_5_2006=selif(VE_ingr_2006~X5_2006, (VE_ingr_2006 .le quantile(VE_ingr_2006, 0.90)).*(X5_2006 .le quantile(X5_2006,0.90)));
Y5_2006=Vars_5_2006[.,1];
X5_2006=Vars_5_2006[.,2];

jij=1;
do while jij .le 500;
if jij .eq 1;
X5_values_2006=quantile(X5_2006,0.01);
else;
X5_values_2006=X5_values_2006|X5_values_2006[jij-1]+(quantile(X5_2006,0.90)-quantile(X5_2006,0.01))/499;
endif;
if maxc(X5_values_2006 .le quantile(X5_2006,0.90));
jij=jij+1;
else;
jij=501;
endif;
...
N5=rows(Y5_2006);
N5_vals=rows(X5_values_2006);

sigma_X5=stdc(X5_2006);
C_h=4;
alpha_h=1/5;
bandwidth_1=C_h*sigma_X5*N5^(-alpha_h);

E_Y_X5_2006=zeros(N5_vals,1);

i=1;
do while i .le N5_vals;
X5_val=X5_values_2006[i];
psi=(X5_2006-X5_val)/bandwidth_1;
kernel_vector=pdfn(psi);
E_Y_X5_2006[i]=meanc(Y5_2006.*kernel_vector)/meanc(kernel_vector);	
i=i+1;
endo;


Vars_6_2006=selif(VE_ingr_2006~X6_2006, (VE_ingr_2006 .le quantile(VE_ingr_2006, 0.90)).*(X6_2006 .le quantile(X6_2006,0.90)));
Y6_2006=Vars_6_2006[.,1];
X6_2006=Vars_6_2006[.,2];

jij=1;
do while jij .le 500;
if jij .eq 1;
X6_values_2006=quantile(X6_2006,0.01);
else;
X6_values_2006=X6_values_2006|X6_values_2006[jij-1]+(3000-quantile(X6_2006,0.01))/499;	
endif;
if maxc(X6_values_2006 .le 3000);
jij=jij+1;
else;
jij=501;
endif;
...
N6=rows(Y6_2006);
N6_vals=rows(X6_values_2006);

sigma_X6=stdc(X6_2006);
C_h=4;
alpha_h=1/5;
bandwidth_1=C_h*sigma_X6*N6^(-alpha_h);

E_Y_X6_2006=zeros(N6_vals,1);

i=1;
do while i .le N6_vals;
X6_val=X6_values_2006[i];
psi=(X6_2006-X6_val)/bandwidth_1;
kernel_vector=pdfn(psi);
E_Y_X6_2006[i]=meanc(Y6_2006.*kernel_vector)/meanc(kernel_vector);	
i=i+1;
endo;


Vars_7_2006=selif(VE_ingr_2006~X7_2006, (VE_ingr_2006 .le quantile(VE_ingr_2006, 0.90)).*(X7_2006 .le quantile(X7_2006,0.90)));
Y7_2006=Vars_7_2006[.,1];
X7_2006=Vars_7_2006[.,2];

jij=1;
do while jij .le 500;
if jij .eq 1;
X7_values_2006=quantile(X7_2006,0.01);
else;
X7_values_2006=X7_values_2006|X7_values_2006[jij-1]+(52-quantile(X7_2006,0.01))/499; /*To match the range of values observed for 2014*/
endif;
if maxc(X7_values_2006 .le 52);
jij=jij+1;
else;
jij=501;
endif;
...
N7=rows(Y7_2006);
N7_vals=rows(X7_values_2006);

sigma_X7=stdc(X7_2006);
C_h=4;
alpha_h=1/5;
bandwidth_1=C_h*sigma_X7*N7^(-alpha_h);

E_Y_X7_2006=zeros(N7_vals,1);

i=1;
do while i .le N7_vals;
X7_val=X7_values_2006[i];
psi=(X7_2006-X7_val)/bandwidth_1;
kernel_vector=pdfn(psi);
E_Y_X7_2006[i]=meanc(Y7_2006.*kernel_vector)/meanc(kernel_vector);	
i=i+1;
endo;
